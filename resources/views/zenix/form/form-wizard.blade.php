			...
			<div class="container-fluid">
				...
				<div class="row page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="javascript:void(0);">Wizard</a></li>
					</ol>
                </div>
                <!-- row -->
                <div class="row">
                            ...
                            <div class="card-body">
								<div id="smartwizard" class="form-wizard order-create">
									<ul class="nav nav-wizard">
										<li><a class="nav-link x" href="#wizard_Service"> 
											<span>1</span> 
										</a></li>
										<li><a class="nav-link x" href="#wizard_Time">
											<span>2</span>
										</a></li>
										<li><a class="nav-link x" href="#wizard_Details">
											<span>3</span>
										</a></li>
										<li><a class="nav-link x" href="#wizard_Payment">
											<span>4</span>
										</a></li>
									</ul>
