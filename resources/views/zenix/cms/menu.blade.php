								...
								<div class="card-body">
									<div class="row align-items-center">
										...
										<div class="col-xl-3 col-xxl-4 col-lg-4">
											<a href="javascript:void(0);" class="btn btn-primary btn-sm mx-1">Select</a>
													...
													<div class="card-body ItemsCheckboxSec p-sm-4">
														<ul class=" tab-my nav nav-tabs" id="myTab" role="tablist">
														  <li class="nav-item" role="presentation">
															<button class="nav-link style-1 active" id="Viewall-tab" data-bs-toggle="tab" data-bs-target="#Viewall-tab-pane" type="button" role="tab" aria-controls="Viewall-tab-pane" aria-selected="true">View All</button>
														  </li>
														  <li class="nav-item" role="presentation">
															<button class="nav-link style-1" id="Search-tab" data-bs-toggle="tab" data-bs-target="#Search-tab-pane" type="button" role="tab" aria-controls="Search-tab-pane" aria-selected="false">Search</button>
														  </li>
														...
														<li class="dd-item menu-ac-item" data-id="1">
															...
															<div class="accordion" id="accordionExample-1">
																<div class="accordion-item">
																	...
																	<div id="collapse-1" class="accordion-collapse" aria-labelledby="heading-1" data-bs-parent="#accordionExample-1">
															...
															<div class="accordion" id="accordionExample-2">
																<div class="accordion-item">
																	<div class="accordion-header p-0" id="heading-2">
																	  ...
																	  <button class="accordion-button contact collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-2" aria-expanded="true" aria-controls="collapse-2">
																		Privacy Policy
																	  </button>
																	</div>
															...
															<div class="accordion" id="accordionExample-3">
																<div class="accordion-item">
																	<div class="accordion-header p-0" id="heading-3">
																	  ...
																	  <button class="accordion-button contact collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-3" aria-expanded="true" aria-controls="collapse-3">
															...
															<div class="accordion" id="accordionExample-4">
																<div class="accordion-item">
																	<div class="accordion-header p-0" id="heading-4">
																	  ...
																	  <button class="accordion-button contact collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-4" aria-expanded="true" aria-controls="collapse-4">
																		About Us
																	  </button>
																	</div>
															...
															<div class="accordion" id="accordionExample-5">
																<div class="accordion-item">
																	<div class="accordion-header p-0" id="heading-5">
																	  ...
																	  <button class="accordion-button contact collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-5" aria-expanded="true" aria-controls="collapse-5">
																		Important Information
																	  </button>
																	</div>
