      ...
      <div class="card-footer py-0 d-flex flex-wrap justify-content-between align-items-center">
        <ul class="nav nav-underline nav-underline-primary nav-underline-text-dark nav-underline-gap-x-0" id="tabMyProfileBottom" role="tablist">
          <li class="nav-item ms-1" role="presentation">
            <a href="{{ url('profile/overview') }}" class="nav-link py-3 border-3 text-dark active">Overview</a>
          </li>
          <li class="nav-item ms-1" role="presentation">
            <a href="{{ url('profile/projects') }}" class="nav-link py-3 border-3 text-dark">Projects</a>
          </li>
          <li class="nav-item ms-1" role="presentation">
            <a href="{{ url('profile/campaigns') }}" class="nav-link py-3 border-3 text-dark">Campaigns</a>
          </li>
          <li class="nav-item ms-1" role="presentation">
            <a href="{{ url('profile/documents') }}" class="nav-link py-3 border-3 text-dark">Documents</a>
          </li>
          <li class="nav-item ms-1" role="presentation">
            <a href="{{ url('profile/followers') }}" class="nav-link py-3 border-3 text-dark">Followers</a>
          </li>
          <li class="nav-item ms-1" role="presentation">
            <a href="{{ url('profile/activity') }}" class="nav-link py-3 border-3 text-dark">Activity</a>
          </li>
        </ul>
                ...
                <div class="card-body pb-0">
                  <div class="d-flex justify-content-between mb-2">
                    <div class="d-flex align-items-center py-2">
                      <div class="d-inline-block position-relative">
                        <img src="{{ asset('images/avatar/avatar1.jpg') }} " alt="" class="rounded avatar avatar-md">
                      </div>
                      <div class="clearfix ms-2">
                        <h6 class="fs-14 mb-0 fw-semibold">Jackson</h6>
                        <span class="fs-13">Yestarday at 4:30 PM</span>
                      </div>
                    </div>
                    <div class="clearfix ms-auto">
                      <button type="button" class="btn btn-light btn-icon-xxs tp-btn fs-18 align-self-start">
                  ...
                  <div class="clearfix pt-1">
                    <a href="javascript:void(0);" class="me-3">
                      <i class="fa-regular fa-image"></i> 25 </a>
                    <a href="javascript:void(0);" class="post-like">
                      <i class="fa-regular fa-heart"></i> 75 </a>
                  </div>
                  <div class="position-relative border-top border-secondary border-opacity-10 d-flex align-items-center mt-3">
              ...
              <div class="card card-comment">
                <div class="card-body pb-0">
                  <div class="d-flex justify-content-between mb-2">
                    <div class="d-flex align-items-center py-2">
                      <div class="d-inline-block position-relative">
                        <img src="{{ asset('images/avatar/avatar2.jpg') }} " alt="" class="rounded avatar avatar-md">
                      </div>
                      <div class="clearfix ms-2">
                        <h6 class="fs-14 mb-0 fw-semibold">Kennedy</h6>
                  ...
                  <div class="gallery-grid rows-3" id="lightgallery">
                    <a href="{{ asset('images/post/img-full1.jpg') }} " data-exthumbimage="{{ asset('images/post/img-full1.jpg') }} " data-src="{{ asset('images/post/img-full1.jpg') }} " class="grid-item colspan-3 rowspan-2">
                      <img src="{{ asset('images/post/img-full1.jpg') }} " alt="">
                    </a>
                    <a href="{{ asset('images/post/img2.jpg') }} " data-exthumbimage="{{ asset('images/post/img2.jpg') }} " data-src="{{ asset('images/post/img2.jpg') }} " class="grid-item">
                      <img src="{{ asset('images/post/img2.jpg') }} " alt="">
                    </a>
                    <a href="{{ asset('images/post/img1.jpg') }} " data-exthumbimage="{{ asset('images/post/img1.jpg') }} " data-src="{{ asset('images/post/img1.jpg') }} " class="grid-item">
                      <img src="{{ asset('images/post/img1.jpg') }} " alt="">
                    </a>
                    <a href="{{ asset('images/post/img3.jpg') }} " data-exthumbimage="{{ asset('images/post/img3.jpg') }} " data-src="{{ asset('images/post/img3.jpg') }} " class="grid-item gallery-more" data-more="+06">
              ...
              <div class="card card-comment">
                <div class="card-body pb-0">
                  <div class="d-flex justify-content-between mb-2">
                    <div class="d-flex align-items-center py-2">
                      <div class="d-inline-block position-relative">
                        <img src="{{ asset('images/avatar/avatar3.jpg') }} " alt="" class="rounded avatar avatar-md">
                      </div>
                      <div class="clearfix ms-2">
                        <h6 class="fs-14 mb-0 fw-semibold">Kennedy</h6>
                        <span class="fs-13">Yestarday at 5:30 PM</span>
                  ...
                  <div class="gallery-grid rows-3" id="lightgallery2">
                    <a href="{{ asset('images/post/img-full2.jpg') }} " data-exthumbimage="{{ asset('images/post/img-full2.jpg') }} " data-src="{{ asset('images/post/img-full2.jpg') }} " class="grid-item colspan-2 rowspan-3">
                      <img src="{{ asset('images/post/img-full2.jpg') }} " alt="">
                    </a>
                    <a href="{{ asset('images/post/img4.jpg') }} " data-exthumbimage="{{ asset('images/post/img4.jpg') }} " data-src="{{ asset('images/post/img4.jpg') }} " class="grid-item">
                      <img src="{{ asset('images/post/img4.jpg') }} " alt="">
                    </a>
                    <a href="{{ asset('images/post/img5.jpg') }} " data-exthumbimage="{{ asset('images/post/img5.jpg') }} " data-src="{{ asset('images/post/img5.jpg') }} " class="grid-item">
                      <img src="{{ asset('images/post/img5.jpg') }} " alt="">
                    </a>
                    <a href="{{ asset('images/post/img6.jpg') }} " data-exthumbimage="{{ asset('images/post/img6.jpg') }} " data-src="{{ asset('images/post/img6.jpg') }} " class="grid-item gallery-more" data-more="+3">
              ...
              <div class="card card-comment">
                <div class="card-body pb-0">
                  <div class="d-flex justify-content-between mb-2">
                    <div class="d-flex align-items-center py-2">
                      <div class="d-inline-block position-relative">
                        <img src="{{ asset('images/avatar/avatar4.jpg') }} " alt="" class="rounded avatar avatar-md">
                      </div>
                      <div class="clearfix ms-2">
                        <h6 class="fs-14 mb-0 fw-semibold">Kennedy</h6>
                        <span class="fs-13">Yestarday at 5:30 PM</span>
              ...
              <div class="card card-comment">
                <div class="card-body pb-0">
                  <div class="d-flex justify-content-between mb-2">
                    <div class="d-flex align-items-center py-2">
                      <div class="d-inline-block position-relative">
                        <img src="{{ asset('images/avatar/avatar5.jpg') }} " alt="" class="rounded avatar avatar-md">
                      </div>
                      <div class="clearfix ms-2">
                        <h6 class="fs-14 mb-0 fw-semibold">Kennedy</h6>
                        <span class="fs-13">Yestarday at 5:30 PM</span>
                  ...
                  <div class="post-quote post-quote-img bg-purple p-4 text-center mb-2 rounded" style="background-image: url('{{ asset('images/post/img8.jpg') }} ');">
              ...
              <div class="card card-comment">
                <div class="card-body pb-0">
                  <div class="d-flex justify-content-between mb-2">
                    <div class="d-flex align-items-center py-2">
                      <div class="d-inline-block position-relative">
                        <img src="{{ asset('images/avatar/avatar6.jpg') }} " alt="" class="rounded avatar avatar-md">
                      </div>
                      <div class="clearfix ms-2">
                        <h6 class="fs-14 mb-0 fw-semibold">Kennedy</h6>
                        <span class="fs-13">Yestarday at 5:30 PM</span>
              ...
              <div class="card">
                <div class="card-body pb-0">
                  <div class="d-flex justify-content-between mb-2">
                    <div class="d-flex align-items-center py-2">
                      <div class="d-inline-block position-relative">
                        <img src="{{ asset('images/avatar/avatar7.jpg') }} " alt="" class="rounded avatar avatar-md">
                      </div>
                      <div class="clearfix ms-2">
                        <h6 class="fs-14 mb-0 fw-semibold">Kennedy</h6>
                        <span class="fs-13">Yestarday at 5:30 PM</span>
                  ...
                  <div class="clearfix mb-2">
                    <iframe class="rounded w-100" width="100%" height="166" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/539018871&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true"></iframe>
                  </div>
                  <div class="clearfix">
                    <p class="fs-14 mb-2">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>
                  </div>
              ...
              <div class="card card-comment">
                <div class="card-body pb-0">
                  <div class="d-flex justify-content-between mb-2">
                    <div class="d-flex align-items-center py-2">
                      <div class="d-inline-block position-relative">
                        <img src="{{ asset('images/avatar/avatar8.jpg') }} " alt="" class="rounded avatar avatar-md">
                      </div>
                      <div class="clearfix ms-2">
                        <h6 class="fs-14 mb-0 fw-semibold">Kennedy</h6>
                        <span class="fs-13">Yestarday at 5:30 PM</span>
                  ...
                  <div class="clearfix mb-2 text-center">
                    <img src="{{ asset('images/post/img6.jpg') }} " alt="" class="rounded w-100">
                  </div>
                  <div class="clearfix">
                    <p class="fs-14 mb-2">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>
                  </div>
              ...
              <div class="card card-comment">
                <div class="card-body pb-0">
                  <div class="clearfix mb-3">
                    <div class="d-flex justify-content-between mb-2">
                      <div class="d-flex align-items-center py-2">
                        ...
                        <div class="clearfix ms-2">
                          <h6 class="fs-14 mb-0 fw-semibold">Brad Dennis</h6>
                  ...
                  <div class="d-flex py-2 position-relative">
                    <div class="d-inline-block position-relative">
                      <img src="{{ asset('images/avatar/5.jpg') }} " alt="" class="rounded avatar avatar-md">
                    </div>
                    <div class="clearfix ms-2">
                      <h6 class="fs-13 mb-1 fw-semibold">Mr. Hamilton <span class="fs-12 text-muted ms-1 fw-normal">2 Day ago</span>
                      </h6>
                      <p class="fs-12 mb-0">There are many variations of passages of Lorem Ipsum available.</p>
                    </div>
                  ...
                  <div class="d-flex py-2 position-relative">
                    ...
                    <div class="clearfix ms-2">
                      <h6 class="fs-13 mb-1 fw-semibold">Mrs. Anderson <span class="fs-12 text-muted ms-1 fw-normal">3 Days ago</span>
                      </h6>
                      <p class="fs-12 mb-0">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form.</p>
                    </div>
                    <a href="javascript:void(0);" class="position-absolute end-0 top-0">Reply</a>
                  </div>
                  <div class="position-relative border-top border-secondary border-opacity-10 d-flex align-items-center mt-3">
                ...
                <div class="card-body pb-0">
                  <div class="d-flex justify-content-between mb-2">
                    <div class="d-flex align-items-center py-2">
                      ...
                      <div class="clearfix ms-2">
                        <h6 class="fs-14 mb-0 fw-semibold">Lewis</h6>
                  ...
                  <div class="clearfix pt-1">
                    <a href="javascript:void(0);" class="me-3">
                      <i class="fa-regular fa-image"></i> 24 </a>
                    <a href="javascript:void(0);" class="post-like">
                      <i class="fa-regular fa-heart"></i> 75 </a>
                  </div>
                  <div class="position-relative border-top border-secondary border-opacity-10 d-flex align-items-center mt-3">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="d-flex align-items-center p-2 hover-bg-light rounded my-1">
                    <div class="avatar avatar-md border border-secondary border-opacity-10 rounded d-flex align-items-center justify-content-center bg-white">
                  ...
                  <div class="widget-timeline-status">
                    <ul class="timeline">
                      ...
                      <li>
                        ...
                        <div class="timeline-panel">
                          <span class=" fs-14 fw-semibold">john just buy your product Sell <span class="text-primary">$250</span>
                          </span>
                        </div>
                      </li>
                      <li>
                      ...
                      <li>
                        ...
                        <div class="timeline-panel">
                          <span class="fs-14 fw-semibold">StumbleUpon is acquired by <span class="text-primary">eBay</span>
                          </span>
                        </div>
                      </li>
                      <li>
                ...
                <div class="card-body pt-1">
                  <div class="row align-items-center">
                    <div class="col-sm-6 mb-3">
                      <div id="chartTopSelling" class="d-flex justify-content-center"></div>
                    </div>
                    <div class="col-sm-6 mb-3">
                      ...
                      <div class="sub-card draggable-handle draggable">
                        <div class="d-items">
                          <span class="text-success dang d-block mb-2">
                            ...
                            </svg> Latest finished to do's </span>
                          <div class="d-flex justify-content-between flex-wrap">
                            <div class="d-items-2">
                              <div>
                                <svg width="9" height="16" viewBox="0 0 9 16" fill="none" xmlns="http://www.w3.org/2000/svg">
