...
<div class="content-body">
  <div class="container-fluid">
    <div class="row page-titles">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
          <a href="javascript:void(0);">Projects Details</a>
        </li>
      </ol>
    </div>
    <div class="card profile-overview profile-overview-wide">
      ...
      <div class="card-footer py-0 d-flex flex-wrap justify-content-between align-items-center">
        <ul class="nav nav-underline nav-underline-primary nav-underline-text-dark nav-underline-gap-x-0" id="tabMyProfileBottom" role="tablist">
          ...
          <li class="nav-item ms-1" role="presentation">
            <a href="{{ url('profile/projects') }}" class="nav-link py-3 border-3 text-dark active">Projects</a>
          </li>
          <li class="nav-item ms-1" role="presentation">
    ...
    <div class="tab-content" id="tabContentMyProfileBottom">
      ...
      <div class="row">
        <div class="col-xl-4 col-xxl-6 col-lg-12">
          <div class="card">
            ...
            <div class="card-body">
              <div class="row align-items-center">
                <div class="col-sm-6 mb-3">
                  <div id="chartTasksSummary" class="project-chart d-flex justify-content-center"></div>
                </div>
                <div class="col-sm-6 mb-3">
              ...
              <div class="clearfix">
                ...
                <div class="clearfix d-flex">
                  <div class="chart-series me-3" id="seriesIncomplete">
                    ...
                    <input class="d-none" type="checkbox" id="checkSeriesIncomplete" name="chart-series" value="Incomplete">
                  ...
                  <div class="chart-series" id="seriesComple">
                    ...
                    <input class="d-none" type="checkbox" id="checkSeriesComple" name="chart-series" value="Comple">
            ...
            <div class="card-body">
              <div class="d-flex align-items-center py-2">
                <div class="d-inline-block position-relative">
                  <img src="{{ asset('images/avatar/5.jpg') }} " alt="" class="rounded-circle avatar avatar-sm">
                  <span class="fa fa-circle text-success position-absolute bottom-0 end-0 fs-8"></span>
                </div>
                <div class="clearfix ms-3">
                  <h6 class="fs-13 mb-0 fw-semibold">Karina Clark</h6>
              ...
              <div class="d-flex align-items-center py-2">
                <div class="d-inline-block position-relative">
                  <img src="{{ asset('images/avatar/6.jpg') }} " alt="" class="rounded-circle avatar avatar-sm">
                  <span class="fa fa-circle text-success position-absolute bottom-0 end-0 fs-8"></span>
                </div>
                <div class="clearfix ms-3">
                  <h6 class="fs-13 mb-0 fw-semibold">Rober Doe</h6>
                  <span class="fs-13">8 Pending & 97 Completed Tasks</span>
                </div>
                <div class="clearfix ms-auto">
              ...
              <div class="d-flex align-items-center py-2">
                <div class="avatar avatar-sm bg-success-light text-success rounded-circle d-flex align-items-center justify-content-center">N</div>
                <div class="clearfix ms-3">
                  <h6 class="fs-13 mb-0 fw-semibold">Neil Owen</h6>
                  <span class="fs-13">8 Pending & 97 Completed Tasks</span>
                </div>
                <div class="clearfix ms-auto">
              ...
              <div class="d-flex align-items-center py-2">
                <div class="d-inline-block position-relative">
                  <img src="{{ asset('images/avatar/7.jpg') }} " alt="" class="rounded-circle avatar avatar-sm">
                  <span class="fa fa-circle text-success position-absolute bottom-0 end-0 fs-8"></span>
                </div>
                <div class="clearfix ms-3">
                  <h6 class="fs-13 mb-0 fw-semibold">Olivia Wild</h6>
                  <span class="fs-13">8 Pending & 97 Completed Tasks</span>
                </div>
                <div class="clearfix ms-auto">
              ...
              <div class="d-flex align-items-center py-2">
                <div class="d-inline-block position-relative">
                  <div class="avatar avatar-sm bg-info-light text-info rounded-circle d-flex align-items-center justify-content-center">S</div>
                  <span class="fa fa-circle bored border-light text-success position-absolute bottom-0 end-0 fs-8"></span>
                </div>
                <div class="clearfix ms-3">
                  <h6 class="fs-13 mb-0 fw-semibold">Sean Bean</h6>
                  <span class="fs-13">8 Pending & 97 Completed Tasks</span>
                </div>
                <div class="clearfix ms-auto">
                  <span class="badge badge-sm badge-light">3</span>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="d-flex align-items-center py-2">
                ...
                <div class="clearfix ms-2">
                  <h6 class="fs-13 mb-0 fw-semibold">Create FureStibe branding logo</h6>
                  <span class="fs-13">Due in 1 day <span class="text-primary">Karina Clark</span>
                  </span>
                </div>
                <div class="clearfix ms-auto">
                  <button type="button" class="btn btn-light btn-icon-xxs tp-btn fs-18 align-self-start">
              ...
              <div class="d-flex align-items-center py-2">
                ...
                <div class="clearfix ms-2">
                  <h6 class="fs-13 mb-0 fw-semibold">Schedule a meeting with FireBear CTO John</h6>
                  <span class="fs-13">Due in 3 days <span class="text-primary">Rober Doe</span>
                  </span>
                </div>
                <div class="clearfix ms-auto">
                  <button type="button" class="btn btn-light btn-icon-xxs tp-btn fs-18 align-self-start">
              ...
              <div class="d-flex align-items-center py-2">
                ...
                <div class="clearfix ms-2">
                  <h6 class="fs-13 mb-0 fw-semibold">9 Degree Porject Estimation</h6>
                  <span class="fs-13">Due in 1 week <span class="text-primary">Neil Owen</span>
                  </span>
                </div>
                <div class="clearfix ms-auto">
                  <button type="button" class="btn btn-light btn-icon-xxs tp-btn fs-18 align-self-start">
              ...
              <div class="d-flex align-items-center py-2">
                ...
                <div class="clearfix ms-2">
                  <h6 class="fs-13 mb-0 fw-semibold">Dashgboard UI & UX for Leafr CRM</h6>
                  <span class="fs-13">Due in 1 week <span class="text-primary">Olivia Wild</span>
                  </span>
                </div>
                <div class="clearfix ms-auto">
                  <button type="button" class="btn btn-light btn-icon-xxs tp-btn fs-18 align-self-start">
              ...
              <div class="d-flex align-items-center py-2">
                ...
                <div class="clearfix ms-2">
                  <h6 class="fs-13 mb-0 fw-semibold">Mivy App R&D, Meeting with clients</h6>
                  <span class="fs-13">Due in 2 weeks <span class="text-primary">Sean Bean</span>
                  </span>
                </div>
                <div class="clearfix ms-auto">
                  <button type="button" class="btn btn-light btn-icon-xxs tp-btn fs-18 align-self-start">
            ...
            <div class="card-body">
              <div class="d-flex align-items-center py-2">
                <div class="d-flex align-items-center">
                  ...
                  <div class="clearfix">
                    <h6 class="fs-13 mb-0 fw-semibold">Project tech requirements</h6>
                    <span class="fs-13">2 days ago <span class="text-primary">Karina Clark</span>
                    </span>
                  </div>
                </div>
                <div class="clearfix ms-auto">
              ...
              <div class="alert alert-primary border-primary outline-dashed py-3 px-3 d-flex align-items-center mb-0 mt-3">
                ...
                <div class="mx-3">
                  <h6 class="fs-14 fw-semibold mb-1">Quick file uploader</h6>
                  <p class="fs-14 mb-0 text-dark">Drag & Drop or choose files from computer</p>
                </div>
              </div>
            </div>
          </div>
