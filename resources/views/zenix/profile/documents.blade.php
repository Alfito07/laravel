    ...
    <div class="card profile-overview profile-overview-wide">
      ...
      <div class="card-footer py-0 d-flex flex-wrap justify-content-between align-items-center">
        <ul class="nav nav-underline nav-underline-primary nav-underline-text-dark nav-underline-gap-x-0" id="tabMyProfileBottom" role="tablist">
          ...
          <li class="nav-item ms-1" role="presentation">
            <a href="{{ url('profile/documents') }}" class="nav-link py-3 border-3 text-dark active">Documents</a>
          </li>
          <li class="nav-item ms-1" role="presentation">
      ...
      <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div class="d-flex align-items-center">
          <ul class="nav nav-pills" id="myTabView" role="tablist">
            <li class="nav-item ms-1" role="presentation">
              <button class="nav-link btn btn-light btn-sharp p-0 active" id="project-list-tab" data-bs-toggle="tab" data-bs-target="#project-list-pane" type="button" role="tab" aria-controls="project-list-pane" aria-selected="true">
            ...
            <li class="nav-item ms-1" role="presentation">
              <button class="nav-link btn btn-light btn-sharp p-0" id="project-grid-tab" data-bs-toggle="tab" data-bs-target="#project-grid-pane" type="button" role="tab" aria-controls="project-grid-pane" aria-selected="false">
          ...
          <div class="row">
            <div class="col-xl-3 col-md-4 col-sm-6">
              <div class="card">
                <div class="card-body px-4 py-3 d-flex align-items-center gap-3">
                  <div>
                    <img src="{{ asset('images/files/folder.png') }} " width="45" alt="">
                  </div>
                  <div class="clearfix">
            ...
            <div class="col-xl-3 col-md-4 col-sm-6">
              <div class="card">
                <div class="card-body px-4 py-3 d-flex align-items-center gap-3">
                  <div>
                    <img src="{{ asset('images/files/folder.png') }} " width="35" alt="">
                  </div>
                  <div class="clearfix">
            ...
            <div class="col-xl-3 col-md-4 col-sm-6">
              <div class="card">
                <div class="card-body px-4 py-3 d-flex align-items-center gap-3">
                  <div>
                    <img src="{{ asset('images/files/html.png') }} " width="35" alt="">
                  </div>
                  <div class="clearfix">
            ...
            <div class="col-xl-3 col-md-4 col-sm-6">
              <div class="card">
                <div class="card-body px-4 py-3 d-flex align-items-center gap-3">
                  <div>
                    <img src="{{ asset('images/files/ppt.png') }} " width="35" alt="">
                  </div>
                  <div class="clearfix">
            ...
            <div class="col-xl-3 col-md-4 col-sm-6">
              <div class="card">
                <div class="card-body px-4 py-3 d-flex align-items-center gap-3">
                  <div>
                    <img src="{{ asset('images/files/mp3.png') }} " width="35" alt="">
                  </div>
                  <div class="clearfix">
          ...
          <div class="row">
              ...
              <div class="card">
                <div class="card-body text-center p-4 d-flex flex-column justify-content-between">
                  <div class="m-auto pb-3">
                    <img src="{{ asset('images/files/folder.png') }} " alt="">
                  </div>
                  <div class="clearfix">
            ...
            <div class="col-xl-2 col-lg-4 col-sm-6">
              <div class="card">
                <div class="card-body text-center p-4 d-flex flex-column justify-content-between">
                  <div class="m-auto pb-3">
                    <img src="{{ asset('images/files/csv.png') }} " alt="">
                  </div>
                  <div class="clearfix">
            ...
            <div class="col-xl-2 col-lg-4 col-sm-6">
              <div class="card">
                <div class="card-body text-center p-4 d-flex flex-column justify-content-between">
                  <div class="m-auto pb-3">
                    <img src="{{ asset('images/files/css.png') }} " alt="">
                  </div>
                  <div class="clearfix">
            ...
            <div class="col-xl-2 col-lg-4 col-sm-6">
              <div class="card">
                <div class="card-body text-center p-4 d-flex flex-column justify-content-between">
                  <div class="m-auto pb-3">
                    <img src="{{ asset('images/files/pdf.png') }} " alt="">
                  </div>
                  <div class="clearfix">
            ...
            <div class="col-xl-2 col-lg-4 col-sm-6">
              <div class="card">
                <div class="card-body text-center p-4 d-flex flex-column justify-content-between">
                  <div class="m-auto pb-3">
                    <img src="{{ asset('images/files/html.png') }} " alt="">
                  </div>
                  <div class="clearfix">
            ...
            <div class="col-xl-2 col-lg-4 col-sm-6">
              <div class="card">
                <div class="card-body text-center p-4 d-flex flex-column justify-content-between">
                  <div class="m-auto pb-3">
                    <img src="{{ asset('images/files/ppt.png') }} " alt="">
                  </div>
                  <div class="clearfix">
            ...
            <div class="col-xl-2 col-lg-4 col-sm-6">
              <div class="card">
                <div class="card-body text-center p-4 d-flex flex-column justify-content-between">
                  <div class="m-auto pb-3">
                    <img src="{{ asset('images/files/mp3.png') }} " alt="">
                  </div>
                  <div class="clearfix">
