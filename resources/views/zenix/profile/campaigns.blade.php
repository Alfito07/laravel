    ...
    <div class="card profile-overview profile-overview-wide">
      ...
      <div class="card-footer py-0 d-flex flex-wrap justify-content-between align-items-center">
        <ul class="nav nav-underline nav-underline-primary nav-underline-text-dark nav-underline-gap-x-0" id="tabMyProfileBottom" role="tablist">
          ...
          <li class="nav-item ms-1" role="presentation">
            <a href="{{ url('profile/campaigns') }}" class="nav-link py-3 border-3 text-dark active">Campaigns</a>
          </li>
          <li class="nav-item ms-1" role="presentation">
              ...
              <div class="p-2">
                <div class="d-flex justify-content-between mb-4">
                  <div class="d-flex align-items-center">
                    ...
                    <span class="ms-3">Twitch Ads</span>
                  </div>
                ...
                <p class="mb-0">
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M5.83334 14.1668L14.1667 5.8335" stroke="var(--bs-success)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M5.83334 5.8335H14.1667V14.1668" stroke="var(--bs-success)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                  </svg>
                  <span class="text-success me-1">+32.40%</span> more spending
                </p>
              </div>
            </div>
          </div>
            ...
            <div class="card-body p-4">
              <div class="p-2">
                ...
                <p class="mb-0">
                  ...
                  <span class="text-success me-1">+8.80%</span> folowers growth
                </p>
              </div>
            </div>
          </div>
              ...
              <div class="p-2">
                <div class="d-flex justify-content-between mb-4">
                  <div class="d-flex align-items-center">
                    ...
                    <span class="ms-3">Spotify Listerners</span>
                  </div>
                  <button type="button" class="btn btn-light btn-icon-xxs tp-btn fs-18 align-self-start">
                    <i class="bi bi-grid"></i>
                  </button>
                ...
                <p class="mb-0">
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M14.1667 5.8335L5.83337 14.1668" stroke="var(--bs-danger)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M14.1667 14.1668H5.83337V5.8335" stroke="var(--bs-danger)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                  </svg>
                  <span class="text-danger me-1">-10%</span> less comments than usual
                </p>
              </div>
            </div>
          </div>
              ...
              <div class="p-2">
                <div class="d-flex justify-content-between mb-4">
                  <div class="d-flex align-items-center">
                    ...
                    <span class="ms-3">Telegram Posts</span>
                  </div>
                  <button type="button" class="btn btn-light btn-icon-xxs tp-btn fs-18 align-self-start">
                    <i class="bi bi-grid"></i>
                  </button>
                ...
                <p class="mb-0">
                  ...
                  <span class="text-success me-1">+25%</span> more spending
                </p>
              </div>
            </div>
          </div>
              ...
              <div class="p-2">
                <div class="d-flex justify-content-between mb-4">
                  <div class="d-flex align-items-center">
                    ...
                    <span class="ms-3">Pintrest Posts</span>
                  </div>
                  <button type="button" class="btn btn-light btn-icon-xxs tp-btn fs-18 align-self-start">
                    <i class="bi bi-grid"></i>
                  </button>
                ...
                <p class="mb-0">
                  ...
                  <span class="text-success me-1">+58.32%</span> more posts
                </p>
              </div>
            </div>
          </div>
              ...
              <div class="p-2">
                <div class="d-flex justify-content-between mb-4">
                  <div class="d-flex align-items-center">
                    ...
                    <span class="ms-3">Github Contributes</span>
                  </div>
                  <button type="button" class="btn btn-light btn-icon-xxs tp-btn fs-18 align-self-start">
                    <i class="bi bi-grid"></i>
                  </button>
                ...
                <p class="mb-0">
                  ...
                  <span class="text-danger me-1">-12.50%</span> less contributes than usual
                </p>
              </div>
            </div>
          </div>
              ...
              <div class="p-2">
                <div class="d-flex justify-content-between mb-4">
                  <div class="d-flex align-items-center">
                    ...
                    <span class="ms-3">Youtube Subscribers</span>
                  </div>
                  <button type="button" class="btn btn-light btn-icon-xxs tp-btn fs-18 align-self-start">
                    <i class="bi bi-grid"></i>
                  </button>
                ...
                <p class="mb-0">
                  ...
                  <span class="text-success me-1">+5.50%</span> subscribewrs growth
                </p>
              </div>
            </div>
          </div>
              ...
              <div class="p-2">
                <div class="d-flex justify-content-between mb-4">
                  <div class="d-flex align-items-center">
                    ...
                    <span class="ms-3">Reddit Awards</span>
                  </div>
                  <button type="button" class="btn btn-light btn-icon-xxs tp-btn fs-18 align-self-start">
                    <i class="bi bi-grid"></i>
                  </button>
                ...
                <p class="mb-0">
                  ...
                  <span class="text-success me-1">+5.52%</span> folowers growth
                </p>
              </div>
            </div>
          </div>
