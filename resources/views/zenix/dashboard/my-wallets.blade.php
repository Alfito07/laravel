...
<div class="content-body">
  <div class="container-fluid">
    <div class="form-head mb-sm-5 mb-3 d-flex align-items-center flex-wrap">
      ...
      <a href="javascript:void(0);" class="btn btn-outline-secondary me-3 mb-2">
        <i class="las la-calendar scale5 me-2"></i>Filter Periode </a>
          ...
          <div class="swiper-container card-swiper">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="card-bx stacked card mt-2">
                        ...
                        <div>
                          ...
                          <div class="btn-group theme-colors" data-bs-toggle="buttons">
                            <label class="btn btn-primary btn-sm active">
                              <input type="radio" class="position-absolute invisible" name="options" id="option5">
                              <i class="las la-check-circle"></i>
                            </label>
                            <label class="btn btn-warning btn-sm">
                              <input type="radio" class="position-absolute invisible" name="options" id="option1" checked="">
                              <i class="las la-check-circle"></i>
                            </label>
                            <label class="btn btn-success btn-sm">
                              <input type="radio" class="position-absolute invisible" name="options" id="option2">
                              <i class="las la-check-circle"></i>
                            </label>
                            <label class="btn btn-info btn-sm">
                              <input type="radio" class="position-absolute invisible" name="options" id="option3">
                              <i class="las la-check-circle"></i>
                            </label>
                            <label class="btn btn-secondary btn-sm">
                              <input type="radio" class="position-absolute invisible" name="options" id="option4">
                              <i class="las la-check-circle"></i>
                            </label>
                          </div>
                        </div>
              ...
              <div class="card-body pt-3">
                <div class="flex-wrap mb-sm-4 mb-2 align-items-center">
                  <div class="d-flex align-items-center">
                    ...
                    <span class="fs-22 text-success">7% <i class="fa fa-caret-up scale5 ms-2 text-success" aria-hidden="true"></i>
                    </span>
                  </div>
                  <p class="mb-0 text-black me-auto">Last Week <span class="text-success">$563,443</span>
                  </p>
                </div>
          ...
          <div class="col-xl-12">
            <div class="card">
              ...
              <div class="card-footer border-0 p-0 caret">
                <a href="{{ url('coin-details') }}" class="btn-link mt-1">
