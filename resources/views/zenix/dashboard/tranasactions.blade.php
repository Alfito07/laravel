...
<div class="content-body">
  <div class="container-fluid">
    <div class="form-head d-flex align-items-center flex-wrap mb-sm-5 mb-3">
      <h2 class="font-w600 mb-0 text-black">Transaction</h2>
      <a href="javascript:void(0);" class="btn btn-outline-secondary ms-auto">
          ...
          <table class="table display mb-4 dataTablesCard short-one card-table text-black" id="example6">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <p class="mb-0 wspace-no">Lorem ipsum dol.. <a href="javascript:void(0);" class="text-secondary">More</a>
                  </p>
                </td>
                <td>
              ...
              <tr>
                ...
                <td>
                  <p class="mb-0 text-dark">Lorem ipsum dol. <a href="javascript:void(0);" class="text-secondary">More</a>
                  </p>
                </td>
                <td>
              ...
              <tr>
                ...
                <td>
                  <p class="mb-0">Lorem ipsum dol.. <a href="javascript:void(0);" class="text-secondary">More</a>
                  </p>
                </td>
                <td>
                  <a href="javascript:void(0);" class="btn-link text-success float-right">COMPLETED</a>
