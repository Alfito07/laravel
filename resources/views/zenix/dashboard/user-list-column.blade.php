        ...
        <div class="card user-card">
          <div class="card-body pb-0">
            <div class="d-flex mb-3 align-items-center">
              ...
              <div>
                <h5 class="title">
                  <a href="javascript:void(0);">Thomas Djons</a>
                </h5>
            ...
            <ul class="list-group list-group-flush">
              <li class="list-group-item">
                <span class="mb-0 title">Email</span> : <span class="text-black ms-2">example@gmail.com</span>
              </li>
              <li class="list-group-item">
                <span class="mb-0 title">Phone</span> : <span class="text-black ms-2">1238545644</span>
              </li>
              <li class="list-group-item">
                <span class="mb-0 title">Location</span> : <span class="text-black desc-text ms-2">Indonasia</span>
              </li>
            </ul>
          </div>
        ...
        <div class="card user-card">
          <div class="card-body pb-0">
            <div class="d-flex mb-3 align-items-center">
              ...
              <div>
                <h5 class="title">
                  <a href="javascript:void(0);">Oliver Jean</a>
                </h5>
        ...
        <div class="card user-card">
          <div class="card-body pb-0">
            <div class="d-flex mb-3 align-items-center">
              ...
              <div>
                <h5 class="title">
                  <a href="javascript:void(0);">Post Melone</a>
                </h5>
        ...
        <div class="card user-card">
          <div class="card-body pb-0">
            <div class="d-flex mb-3 align-items-center">
              ...
              <div>
                <h5 class="title">
                  <a href="javascript:void(0);">Kevin Mandala</a>
                </h5>
        ...
        <div class="card user-card">
          <div class="card-body pb-0">
            <div class="d-flex mb-3 align-items-center">
              ...
              <div>
                <h5 class="title">
                  <a href="javascript:void(0);">Mc. Kowalski</a>
                </h5>
        ...
        <div class="card user-card">
          <div class="card-body pb-0">
            <div class="d-flex mb-3 align-items-center">
              ...
              <div>
                <h5 class="title">
                  <a href="javascript:void(0);">Rio Fernandez</a>
                </h5>
        ...
        <div class="card user-card">
          <div class="card-body pb-0">
            <div class="d-flex mb-3 align-items-center">
              ...
              <div>
                <h5 class="title">
                  <a href="javascript:void(0);">Chintya Laudia</a>
                </h5>
        ...
        <div class="card user-card">
          <div class="card-body pb-0">
            <div class="d-flex mb-3 align-items-center">
              ...
              <div>
                <h5 class="title">
                  <a href="javascript:void(0);">James Junaidi</a>
                </h5>
                <span class="text-primary">Senior Developer</span>
              </div>
            </div>
        ...
        <div class="card user-card">
          <div class="card-body pb-0">
            <div class="d-flex mb-3 align-items-center">
              ...
              <div>
                <h5 class="title">
                  <a href="javascript:void(0);">Keanu Repes</a>
                </h5>
        ...
        <div class="card user-card">
          <div class="card-body pb-0">
            <div class="d-flex mb-3 align-items-center">
              ...
              <div>
                <h5 class="title">
                  <a href="javascript:void(0);">Tonni Sblak</a>
                </h5>
                <span class="text-primary">Senior Developer</span>
              </div>
            </div>
        ...
        <div class="card user-card">
          <div class="card-body pb-0">
            <div class="d-flex mb-3 align-items-center">
              ...
              <div>
                <h5 class="title">
                  <a href="javascript:void(0);">John Kipli</a>
                </h5>
                <span class="text-primary">Senior Developer</span>
              </div>
            </div>
        ...
        <div class="card user-card">
          <div class="card-body pb-0">
            <div class="d-flex mb-3 align-items-center">
              ...
              <div>
                <h5 class="title">
                  <a href="javascript:void(0);">Monalisa</a>
                </h5>
