  ...
  <div class="container-fluid">
    <div class="form-head mb-sm-5 mb-3 d-flex flex-wrap align-items-center">
      ...
      <div class="weather-btn mb-2">
        <span class="me-3 font-w600 text-black">
          <i class="fa fa-cloud me-2"></i>21 </span>
      ...
      <a href="javascript:void(0);" class="btn btn-secondary mb-2">
        <i class="las la-calendar scale5 me-3"></i>Filter Periode </a>
    </div>
    <div class="row">
            ...
            <div class="d-flex flex-wrap mb-2">
              <div class="form-check me-4 mb-2">
                ...
                <label class="form-check-label" for="flexCheckDefault1">
                  <span class="d-block  font-w500">BTS</span>
                </label>
              </div>
              <div class="form-check me-4 mb-2">
                <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault2">
                <label class="form-check-label" for="flexCheckDefault2">
                  <span class="d-block  font-w500">XRP</span>
                </label>
              </div>
              <div class="form-check me-4 mb-2">
                <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault3">
                <label class="form-check-label" for="flexCheckDefault3">
                  <span class="d-block  font-w500">ETH</span>
                </label>
              </div>
              <div class="form-check me-4 mb-2">
                <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault4">
                <label class="form-check-label" for="flexCheckDefault4">
                  <span class="d-block  font-w500">ZEC</span>
                </label>
              </div>
            </div>
            <select class="style-1 btn-secondary default-select">
              <option>Weekly (2024)</option>
              <option>Daily (2024)</option>
          ...
          <div class="col-sm-6">
            <div class="card">
              ...
              <div class="card-footer border-0 p-0 caret">
                <a href="{{ url('coin-details') }}" class="btn-link">
            ...
            <div class="card">
              <div class="card-header d-sm-flex d-block pb-0 border-0">
                ...
                <select class="form-control custom-image-select image-select mt-3 mt-sm-0">
                  <option data-thumbnail="{{ asset('images/svg/ltc.svg') }} ">Yearly (2024)</option>
                  <option data-thumbnail="{{ asset('images/svg/eth.svg') }} ">Weekly (2024)</option>
                  <option data-thumbnail="{{ asset('images/svg/btc.svg') }} ">Daily (2024)</option>
                </select>
              </div>
              <div class="card-body">
                    ...
                    <div class="row mt-4 align-items-center">
                      ...
                      <div class="col-lg-6">
                        <div class="d-flex justify-content-end">
                          <a href="javascript:void(0);" class="btn  btn-success text-white text-nowrap"> BUY <svg class="ms-3 scale3" width="16" height="16" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <a href="javascript:void(0);" class="btn btn-danger ms-3 text-nowrap"> SELL <svg class="ms-3 scale5" width="16" height="16" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div class="card-header pb-2 d-block d-sm-flex flex-wrap border-0">
                ...
                <div class="card-action card-tabs mb-3 style-1">
                  <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" data-bs-toggle="tab" href="#Today"> Today </a>
                    </li>
                  </ul>
                </div>
              </div>
                ...
                <div class="testimonial-one px-4 owl-right-nav owl-carousel owl-loaded owl-drag">
                  <div class="items">
                    <div class="text-center">
                      ...
                      <h5 class="mb-0">
                        <a class="text-black" href="javascript:void(0);">Samuel</a>
                      </h5>
                  ...
                  <div class="items">
                    <div class="text-center">
                      ...
                      <h5 class="mb-0">
                        <a class="text-black" href="javascript:void(0);">Cindy</a>
                      </h5>
                  ...
                  <div class="items">
                    <div class="text-center">
                      ...
                      <h5 class="mb-0">
                        <a class="text-black" href="javascript:void(0);">David</a>
                      </h5>
                  ...
                  <div class="items">
                    <div class="text-center">
                      ...
                      <h5 class="mb-0">
                        <a class="text-black" href="javascript:void(0);">Martha</a>
                      </h5>
                  ...
                  <div class="items">
                    <div class="text-center">
                      ...
                      <h5 class="mb-0">
                        <a class="text-black" href="javascript:void(0);">Olivia</a>
                      </h5>
