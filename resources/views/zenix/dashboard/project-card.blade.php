          ...
          <div class="card-body">
            <div class="d-flex mb-4 align-items-start">
              <div class="dz-media me-3">
                <img src="{{ asset('images/logos/pic1.jpg') }} " class="img-fluid" alt="">
              </div>
              <div class="me-auto">
                <p class="text-primary mb-1">#P-000441425</p>
                <h5 class="title font-w600 mb-2">
                  <a href="{{ url('post-details') }}" class="text-black">Redesign Zenix Mobile App</a>
                </h5>
            ...
            <div class="row">
              <div class="col-6">
                <div>Questions: <span class="text-black ms-3 font-w600">56</span>
                </div>
                <div>Comments: <span class="text-black ms-3 font-w600">200</span>
                </div>
              </div>
              <div class="col-6">
                <h6>Progress <span class="pull-right">75%</span>
                </h6>
                <div class="progress ">
      ...
      <div class="col-xl-6 col-lg-12">
        <div class="card project-card">
          <div class="card-body">
            <div class="d-flex mb-4 align-items-start">
              <div class="dz-media me-3">
                <img src="{{ asset('images/logos/pic2.jpg') }} " class="img-fluid" alt="">
              </div>
              <div class="me-auto">
                <p class="text-primary mb-1">#P-000441425</p>
                <h5 class="title font-w600 mb-2">
