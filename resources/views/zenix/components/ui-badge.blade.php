                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="bootstrap-badge">
                                    <a href="javascript:void(0);" class="badge badge-circle badge-outline-primary newtex">1</a>
					...
					<div class="col-lg-6">
						<div class="card">
							<div class="card-header d-block">
								<h4 class="card-title">Positioned Badges</h4>
								<p class="mb-0 subtitle">add <code>.position-relative</code> to change the style</p>
							</div>
							<div class="card-body">
								<div class="bootstrap-badge">
					...
					<div class="col-lg-6">
						<div class="card">
							<div class="card-header d-block">
								...
								<p class="mb-0 subtitle">Default bootstrap button badge</p>
							</div>
							<div class="card-body">
								<div class="bootstrap-badge">
