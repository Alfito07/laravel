					...
					<div class="col-xl-6">
                        <div class="card">
                            <div class="card-header d-block">
                                <h4 class="card-title">Example Accordion</h4>
                                <p class="m-0 subtitle">Example accordion. Add <code>accordion</code> class in root</p>
                            </div>
                            <div class="card-body">
					...
					<div class="col-xl-6">
                        <div class="card">
                            <div class="card-header d-block">
                                ...
                                <p class="m-0 subtitle">Flush accordion. Add <code>accordion</code> class in root</p>
                            </div>
                            <div class="card-body">
					...
					<div class="col-xl-6">
                        <div class="card">
                            <div class="card-header d-block">
                                ...
                                <p class="m-0 subtitle">Always open accordion. Add <code>accordion</code> class in root</p>
                            </div>
                            <div class="card-body">
