    ...
    <div class="row page-titles">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
          <a href="javascript:void(0);">Logs & Notifcations</a>
        </li>
      </ol>
    </div>
    <div class="card profile-overview">
      ...
      <div class="card-footer py-0 d-flex flex-wrap justify-content-between align-items-center">
        <ul class="nav nav-underline nav-underline-primary nav-underline-text-dark nav-underline-gap-x-0" id="tabMyProfileBottom" role="tablist">
          ...
          <li class="nav-item ms-1" role="presentation">
            <a href="{{ url('account/logs') }}" class="nav-link py-3 border-3 text-dark active">Logs</a>
          </li>
        </ul>
              ...
              <div class="table-responsive">
                <table class="table mb-1 table-striped-thead table-wide table-sm table-border-last-0">
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <span class="badge badge-sm badge-success light border-0">OK</span>
                      </td>
                      <td>
                        <a href="javascript:void(0);" class="text-primary">POST/project/Zenix/5482344/not_found</a>
                      </td>
                      <td class="text-end">20 Dec 2024, 2:40 pm</td>
                    </tr>
                    <tr>
                      <td>
                        <span class="badge badge-sm badge-danger light border-0">ERROR</span>
                      </td>
                      <td>
                        <a href="javascript:void(0);" class="text-primary">POST/project/Zenix/5482344/invalid</a>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="javascript:void(0);" class="text-primary">POST/project/Zenix/5482344/payment</a>
                      </td>
                      <td class="text-end">20 Dec 2024, 2:40 pm</td>
                    </tr>
                    <tr>
                ...
                <table id="tableLogs" class="table mb-1 table-striped-thead table-wide table-sm">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <a href="javascript:void(0);" class="text-primary">Chrome - Windows</a>
                      </td>
                      <td>236.125.56.78</td>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="javascript:void(0);" class="text-primary">Firefox - Windows</a>
                      </td>
                      <td>236.125.56.54</td>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="javascript:void(0);" class="text-primary">Safari - Mac</a>
                      </td>
                      <td>236.125.56.78</td>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="javascript:void(0);" class="text-primary">iOS - iPhone Pro</a>
                      </td>
                      <td>236.100.56.50</td>
