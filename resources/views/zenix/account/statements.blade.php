  ...
  <div class="container-fluid">
    ...
    <div class="card profile-overview">
      ...
      <div class="card-footer py-0 d-flex flex-wrap justify-content-between align-items-center">
        <ul class="nav nav-underline nav-underline-primary nav-underline-text-dark nav-underline-gap-x-0" id="tabMyProfileBottom" role="tablist">
          ...
          <li class="nav-item ms-1" role="presentation">
            <a href="{{ url('account/statements') }}" class="nav-link py-3 border-3 text-dark active">Statements</a>
          </li>
          <li class="nav-item ms-1" role="presentation">
    ...
    <div class="tab-content" id="tabContentMyProfileBottom">
      <div class="row">
          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <p class="fs-14">Last 30 day earnings calculated. Apart from arranging the order of topics.</p>
                  <div class="row g-2 mb-3">
                    <div class="col-sm-4 col-6">
                      <div class="bg-light rounded p-3">
                        <h6 class="fs-15 mb-0">$6,840</h6>
                        <span class="fs-13">Net Earnings</span>
                      </div>
                    </div>
                    <div class="col-sm-4 col-6">
                      <div class="bg-light rounded p-3">
                        <h6 class="fs-15 mb-0">+17,8%</h6>
                        <span class="fs-13">Change</span>
                      </div>
                    </div>
                    <div class="col-sm-4 col-12">
                      <div class="bg-light rounded p-3">
                        <h6 class="fs-15 mb-0">$1,240</h6>
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <p class="fs-14">Download apart from order of the good awesome invoice topics.</p>
                  <form action="#">
                    <div class="d-flex">
        ...
        <div class="col-xl-8">
          <div class="card">
            <div class="card-header border-0 py-3 pb-0 d-block d-sm-flex">
              <h4 class="heading mb-0">Statement</h4>
              <ul class="nav nav-pills mt-3 mt-sm-0" id="myTab1" role="tablist">
                <li class="nav-item ms-1" role="presentation">
                  <button class="nav-link btn btn-light active " id="week-tab1" data-bs-toggle="tab" data-bs-target="#tabWeek1" type="button" role="tab" aria-controls="tabWeek1" aria-selected="true">Week</button>
                </li>
                <li class="nav-item ms-1" role="presentation">
                  <button class="nav-link btn btn-light" id="month-tab1" data-bs-toggle="tab" data-bs-target="#tabMonth1" type="button" role="tab" aria-controls="tabMonth1" aria-selected="false">Month</button>
                </li>
                <li class="nav-item ms-1" role="presentation">
                  <button class="nav-link btn btn-light" id="year-tab1" data-bs-toggle="tab" data-bs-target="#tabYear1" type="button" role="tab" aria-controls="tabYear1" aria-selected="false">Year</button>
                </li>
                <li class="nav-item ms-1" role="presentation">
                  <button class="nav-link btn btn-light" id="all-tab1" data-bs-toggle="tab" data-bs-target="#tabAll1" type="button" role="tab" aria-controls="tabAll1" aria-selected="false">All</button>
                </li>
              </ul>
            </div>
            <div class="card-body">
              <div class="tab-content">
                <div class="tab-pane active" id="tabWeek1" role="tabpanel" aria-labelledby="week-tab1" tabindex="0">
                    ...
                    <table class="table mb-1 table-striped-thead table-wide table-sm table-border-last-0">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="text-end">
                            <button type="button" class="btn btn-xxs btn-light">Download</button>
                          </td>
                        </tr>
                        <tr>
                          <td>Oct 24, 2020</td>
                          ...
                          <td>Seller Fee</td>
                          <td>
                            <span class="text-danger">$-2.60</span>
                          </td>
                          <td class="text-end">
                            <button type="button" class="btn btn-xxs btn-light">Download</button>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <span class="text-success">$76.00</span>
                          </td>
                          <td class="text-end">
                            <button type="button" class="btn btn-xxs btn-light">Download</button>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>Seller Fee</td>
                          <td>
                            <span class="text-danger">$-1.30</span>
                          </td>
                          <td class="text-end">
                            <button type="button" class="btn btn-xxs btn-light">Download</button>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <span class="text-success">$204.00</span>
                          </td>
                          <td class="text-end">
                            <button type="button" class="btn btn-xxs btn-light">Download</button>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <span class="text-success">$31.00</span>
                          </td>
                          <td class="text-end">
                            <button type="button" class="btn btn-xxs btn-light">Download</button>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <span class="text-success">$52.00</span>
                          </td>
                          <td class="text-end">
                            <button type="button" class="btn btn-xxs btn-light">Download</button>
                          </td>
                ...
                <div class="tab-pane" id="tabMonth1" role="tabpanel" aria-labelledby="month-tab1" tabindex="0">
                  <div class="table-responsive">
                    <table class="table mb-1 table-striped-thead table-wide table-sm table-border-last-0">
                      <thead>
                        <tr>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="text-end">
                            <button type="button" class="btn btn-sm btn-light">Download</button>
                          </td>
                        </tr>
                      </tbody>
                    </table>
                ...
                <div class="tab-pane" id="tabYear1" role="tabpanel" aria-labelledby="year-tab1" tabindex="0">
                  <div class="table-responsive">
                    <table class="table mb-1 table-striped-thead table-wide table-sm table-border-last-0">
                      <thead>
                        <tr>
                ...
                <div class="tab-pane" id="tabAll1" role="tabpanel" aria-labelledby="all-tab1" tabindex="0">
                  <div class="table-responsive">
                    <table class="table mb-1 table-striped-thead table-wide table-sm table-border-last-0">
                      <thead>
                        <tr>
