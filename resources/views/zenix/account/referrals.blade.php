    ...
    <div class="card profile-overview">
      ...
      <div class="card-footer py-0 d-flex flex-wrap justify-content-between align-items-center">
        <ul class="nav nav-underline nav-underline-primary nav-underline-text-dark nav-underline-gap-x-0" id="tabMyProfileBottom" role="tablist">
          ...
          <li class="nav-item ms-1" role="presentation">
            <a href="{{ url('account/referrals') }}" class="nav-link py-3 border-3 text-dark active">Referrals</a>
          </li>
          <li class="nav-item ms-1" role="presentation">
              ...
              <div class="row mb-3">
                ...
                <div class="col-lg-6 mb-3">
                  ...
                  <div class="select-text-wrap">
                    <div class="text-select-copy border border-secondary border-opacity-10 px-3 py-2 rounded mb-3 text-primary">https://dexginzoen.com/reffer/</div>
              ...
              <div class="row mb-2">
                ...
                <div class="col-lg-3 col-sm-6 mb-3">
                  <div class="bg-danger-light rounded p-3 text-center">
                    <h3 class="mb-0 fw-semibold">$5,500</h3>
                    <span class="fs-14 text-danger">Avg Deal Size</span>
                  </div>
                </div>
                <div class="col-lg-3 col-sm-6 mb-3">
                  <div class="bg-primary-light rounded p-3 text-center">
                    <h3 class="mb-0 fw-semibold">780</h3>
                    <span class="fs-14 text-primary">Referral Signups</span>
                  </div>
                </div>
              </div>
              <div class="mb-4">
                <p class="fs-14 mb-0">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
              </div>
              <div class="alert alert-outline-light bg-light bg-opacity-25 outline-dashed p-3 d-sm-flex align-items-center">
                ...
                <div class="mx-sm-3 my-3 my-sm-0">
                  ...
                  <p class="fs-14 mb-0">Securely withdraw money to your bank account, with a $25 fee.</p>
                </div>
          ...
          <div class="card h-auto">
            <div class="card-header border-0 py-3 d-block d-sm-flex pb-0">
              ...
              <ul class="nav nav-pills mt-3 mt-sm-0" id="myTab2" role="tablist">
                <li class="nav-item ms-1" role="presentation">
                  <button class="nav-link btn btn-light active " id="week-tab2" data-bs-toggle="tab" data-bs-target="#tabWeek2" type="button" role="tab" aria-controls="tabWeek2" aria-selected="true">Week</button>
                </li>
                <li class="nav-item ms-1" role="presentation">
                  <button class="nav-link btn btn-light" id="month-tab2" data-bs-toggle="tab" data-bs-target="#tabMonth2" type="button" role="tab" aria-controls="tabMonth2" aria-selected="false">Month</button>
                </li>
                <li class="nav-item ms-1" role="presentation">
                  <button class="nav-link btn btn-light " id="year-tab2" data-bs-toggle="tab" data-bs-target="#tabYear2" type="button" role="tab" aria-controls="tabYear2" aria-selected="false">Year</button>
                </li>
                <li class="nav-item ms-1" role="presentation">
                  <button class="nav-link btn btn-light" id="all-tab2" data-bs-toggle="tab" data-bs-target="#tabAll2" type="button" role="tab" aria-controls="tabAll2" aria-selected="false">All</button>
                </li>
              </ul>
            </div>
            <div class="card-body">
              <div class="tab-content">
                    ...
                    <table class="table mb-1 table-striped-thead table-wide table-sm table-border-last-0">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>26%</td>
                          <td class="text-end">
                            <span class="text-success">$620.00</span>
                          </td>
                        </tr>
                        <tr>
                          <td>578433345</td>
                          ...
                          <td>35%</td>
                          <td class="text-end">
                            <span class="text-success">$1,200.00</span>
                          </td>
                        </tr>
                        <tr>
                          <td>678935899</td>
                          ...
                          <td>35%</td>
                          <td class="text-end">
                            <span class="text-success">$940.00</span>
                          </td>
                        </tr>
                        <tr>
                          <td>098669322</td>
                        ...
                        <tr>
                          ...
                          <td>21%</td>
                          <td class="text-end">
                            <span class="text-success">$380.00</span>
                          </td>
                        </tr>
                        <tr>
                          <td>505432578</td>
                          ...
                          <td>47%</td>
                          <td class="text-end">
                            <span class="text-success">$2,050.00</span>
                          </td>
                        </tr>
                        <tr>
                          <td>256899235</td>
                          ...
                          <td>35%</td>
                          <td class="text-end">
                            <span class="text-success">$820.00</span>
                          </td>
                        </tr>
                      </tbody>
                    </table>
                ...
                <div class="tab-pane" id="tabMonth2" role="tabpanel" aria-labelledby="month-tab2" tabindex="0">
                  <div class="table-responsive">
                    <table class="table mb-1 table-striped-thead table-wide table-sm table-border-last-0">
                      <thead>
                        <tr>
                ...
                <div class="tab-pane" id="tabYear2" role="tabpanel" aria-labelledby="year-tab2" tabindex="0">
                  <div class="table-responsive">
                    <table class="table mb-1 table-striped-thead table-wide table-sm table-border-last-0">
                      <thead>
                        <tr>
                ...
                <div class="tab-pane" id="tabAll2" role="tabpanel" aria-labelledby="all-tab2" tabindex="0">
                  <div class="table-responsive">
                    <table class="table mb-1 table-striped-thead table-wide table-sm table-border-last-0">
                      <thead>
                        <tr>
