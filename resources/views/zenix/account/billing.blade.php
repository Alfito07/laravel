    ...
    <div class="card profile-overview">
      ...
      <div class="card-footer py-0 d-flex flex-wrap justify-content-between align-items-center">
        <ul class="nav nav-underline nav-underline-primary nav-underline-text-dark nav-underline-gap-x-0" id="tabMyProfileBottom" role="tablist">
          ...
          <li class="nav-item ms-1" role="presentation">
            <a href="{{ url('account/settings') }}" class="nav-link py-3 border-3 text-dark">Settings</a>
          </li>
          <li class="nav-item ms-1" role="presentation">
          ...
          <li class="nav-item ms-1" role="presentation">
            <a href="{{ url('account/billing') }}" class="nav-link py-3 border-3 text-dark active">Billing</a>
          </li>
          <li class="nav-item ms-1" role="presentation">
            ...
            <div class="card-body">
              <div class="alert alert-warning border-warning outline-dashed py-3 px-3 mt-1 mb-4 mb-0 text-dark d-flex align-items-center">
                ...
                <div class="mx-3">
                  ...
                  <p class="mb-0">Your Payment was declined. To start using tools, please <a href="javascript:void(0);" class="text-warning">Add Payment Method</a>
                  </p>
                </div>
              </div>
              <div class="row g-3">
                <div class="col-sm-6">
                  <div class="border border-secondary border-opacity-10 rounded p-3">
                    <h6 class="fs-14 mb-2">Remaining Account Credits</h6>
                    <p class="fs-13 mb-2">We will send you a notification soon. <a href="javascript:void(0);" class="text-primary d-block">Make Action Here</a>
                    </p>
                ...
                <div class="col-sm-6">
                  <div class="border border-secondary border-opacity-10 rounded p-3">
                    ...
                    <p class="fs-13 mb-2">We will send you a notification upon Subscription expiration</p>
                ...
                <div class="col-sm-6">
                  <div class="border border-secondary border-opacity-10 rounded p-3 h-100">
                    <h6 class="fs-14">Billing Alerts</h6>
                    <p class="fs-13 mb-2">Create alerts to notify you on Billing. <a href="javascript:void(0);" class="text-primary">My Alerts Here</a>
                    </p>
                    <span class="badge badge-sm badge-success light border-0">New Alert</span>
                  </div>
                </div>
              </div>
              <div class="row align-items-center mt-4">
                <div class="col-lg-6 col-md-7">
                  <h6 class="fs-13 mb-1">Bob Marley <span class="text-muted">Is your last bill payer</span>
                  </h6>
                  <p class="mb-0 fs-13">Extended Pro Package. Up to 100 Agents & 25 Projects. Make your business effective</p>
                </div>
                <div class="col-lg-6 col-md-5 text-md-end mt-3 mt-md-0">
                  <a href="javascript:void(0);" class="btn btn-danger my-1 light">Cancel Subcription</a>
                  <a href="javascript:void(0);" class="btn btn-primary my-1 ms-2">Upgrade Plan</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="row g-3">
                <div class="col-sm-6">
                  <div class="border border-secondary border-opacity-10 rounded p-3">
                    <h6 class="fs-14 mb-3">Marcus Morris <span class="badge badge-sm badge-success light border-0 ms-2">New</span>
                    </h6>
                    ...
                    <a href="javascript:void(0);" class="btn btn-xxs btn-danger light">Delete</a>
                    <a href="javascript:void(0);" class="btn btn-xxs btn-info light">Edit</a>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="border border-secondary border-opacity-10 rounded p-3">
                    <h6 class="fs-14">Marcus Morris <span class="badge badge-sm badge-success light border-0 ms-2">New</span>
                    </h6>
                    <div class="d-flex align-items-center mb-3">
                      <div class="clearfix me-2">
                        <img src="{{ asset('images/card1.jpg') }} " alt="">
              ...
              <div class="row align-items-center mt-4">
                <div class="col-lg-6 col-md-7">
                  <h6 class="fs-13 mb-1">You have 2 active cards. <span class="text-muted">Another 3 are inactive</span>
                  </h6>
                  <p class="mb-0 fs-13">Extended Pro Package. Up to 100 Agents & 25 Projects. Make your business effective</p>
                </div>
                <div class="col-lg-6 col-md-5 text-md-end mt-3 mt-md-0">
                  <a href="javascript:void(0);" class="btn btn-light my-1">Action</a>
                  <a href="javascript:void(0);" class="btn btn-primary my-1 ms-2">Add New Card</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="row g-3">
                <div class="col-sm-6">
                  <div class="border border-secondary border-opacity-10 rounded p-3">
                    <h6 class="fs-14">Address 1 <span class="badge badge-sm badge-success light border-0 ms-2">New</span>
                    </h6>
                    <p class="fs-13">Ap #285-7193 Ullamcorper Avenue Amesbury HI 93373 United States</p>
                    <a href="javascript:void(0);" class="btn btn-xxs btn-danger light">Delete</a>
                    <a href="javascript:void(0);" class="btn btn-xxs btn-info light">Edit</a>
                  </div>
                </div>
              ...
              <div class="row align-items-center mt-4">
                <div class="col-md-6">
                  <h6 class="fs-14 mb-0">Tax Location</h6>
                  <p class="mb-0">United States - 10% VAT <a href="javascript:void(0);" class="text-primary">More Info</a>
                  </p>
                </div>
        ...
        <div class="col-xl-6">
          <div class="card h-auto">
            <div class="card-header border-0 py-3 d-block d-sm-flex pb-0">
              ...
              <ul class="nav nav-pills mt-3 mt-sm-0" id="myTabBillingHistory" role="tablist">
                <li class="nav-item ms-1" role="presentation">
                  <button class="nav-link btn btn-light active" id="week-tab" data-bs-toggle="tab" data-bs-target="#tabWeek" type="button" role="tab" aria-controls="tabWeek" aria-selected="true">Week</button>
                </li>
                <li class="nav-item ms-1" role="presentation">
                  <button class="nav-link btn btn-light " id="month-tab" data-bs-toggle="tab" data-bs-target="#tabMonth" type="button" role="tab" aria-controls="tabMonth" aria-selected="false">Month</button>
                </li>
                <li class="nav-item ms-1" role="presentation">
                  <button class="nav-link btn btn-light" id="year-tab" data-bs-toggle="tab" data-bs-target="#tabYear" type="button" role="tab" aria-controls="tabYear" aria-selected="false">Year</button>
                </li>
                <li class="nav-item ms-1" role="presentation">
                  <button class="nav-link btn btn-light" id="all-tab" data-bs-toggle="tab" data-bs-target="#tabAll" type="button" role="tab" aria-controls="tabAll" aria-selected="false">All</button>
                </li>
              </ul>
            </div>
            <div class="card-body">
              <div class="tab-content">
                <div class="tab-pane active" id="tabWeek" role="tabpanel" aria-labelledby="week-tab" tabindex="0">
                    ...
                    <table class="table mb-1 table-striped-thead table-wide table-sm table-border-last-0">
                      ...
                      <tbody>
                        <tr>
                          <td>Nov 01, 2020</td>
                          <td>
                            <span class="text-primary">Invoice for Ocrober 2020</span>
                          </td>
                          <td>$123.79</td>
                          <td class="text-end">
                            <button type="button" class="btn btn-xxs btn-light">PDF</button>
                            <button type="button" class="btn btn-xxs btn-light ms-2">View</button>
                          </td>
                        </tr>
                        <tr>
                          <td>Oct 08, 2020</td>
                          <td>
                            <span class="text-primary">Invoice for September 2020</span>
                          </td>
                          <td>$98.03</td>
                          <td class="text-end">
                            <button type="button" class="btn btn-xxs btn-light">PDF</button>
                        ...
                        <tr>
                          <td>Aug 01, 2020</td>
                          <td>
                            <span class="text-primary">Invoice for July 2020</span>
                          </td>
                          <td>$142.80</td>
                          <td class="text-end">
                            <button type="button" class="btn btn-xxs btn-light">PDF</button>
                        ...
                        <tr>
                          <td>Jul 01, 2020</td>
                          <td>
                            <span class="text-primary">Invoice for June 2020</span>
                          </td>
                          <td>$123.79</td>
                          <td class="text-end">
                            <button type="button" class="btn btn-xxs btn-light">PDF</button>
                        ...
                        <tr>
                          <td>Jun 01, 2020</td>
                          <td>
                            <span class="text-primary">Invoice for May 2020</span>
                          </td>
                          <td>$123.79</td>
                          <td class="text-end">
                            <button type="button" class="btn btn-xxs btn-light">PDF</button>
                ...
                <div class="tab-pane" id="tabMonth" role="tabpanel" aria-labelledby="month-tab" tabindex="0">
                  <div class="table-responsive">
                    <table class="table mb-1 table-striped-thead table-wide table-sm table-border-last-0">
                      <thead>
                        <tr>
                ...
                <div class="tab-pane" id="tabYear" role="tabpanel" aria-labelledby="year-tab" tabindex="0">
                  <div class="table-responsive">
                    <table class="table mb-1 table-striped-thead table-wide table-sm table-border-last-0">
                      <thead>
                        <tr>
                ...
                <div class="tab-pane" id="tabAll" role="tabpanel" aria-labelledby="all-tab" tabindex="0">
                  <div class="table-responsive">
                    <table class="table mb-1 table-striped-thead table-wide table-sm table-border-last-0">
                      <thead>
                        <tr>
