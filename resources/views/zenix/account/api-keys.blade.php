    ...
    <div class="card profile-overview">
      ...
      <div class="card-footer py-0 d-flex flex-wrap justify-content-between align-items-center">
        <ul class="nav nav-underline nav-underline-primary nav-underline-text-dark nav-underline-gap-x-0" id="tabMyProfileBottom" role="tablist">
          ...
          <li class="nav-item ms-1" role="presentation">
            <a href="{{ url('account/api-keys') }}" class="nav-link py-3 border-3 text-dark active">API Keys</a>
          </li>
          <li class="nav-item ms-1" role="presentation">
...
<script>
  $('.btn-select-text').on('click', function() {
        var temp = $(" < input > ");
          $("body").append(temp); temp.val($(this).parent(".select-text-wrap").find('.text-select-copy').text()).select(); document.execCommand("copy"); temp.remove();
          var $span = $(this).find('span');
          var originalText = $span.text(); $span.text("Copied!"); setTimeout(function() {
