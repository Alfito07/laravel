      ...
      <div class="card-body d-flex">
        ...
        <div class="clearfix d-xl-flex flex-grow-1">
          <div class="clearfix pe-md-5">
            <h3 class="fw-semibold mb-1">Marquez <img src="{{ asset('images/blue-tick.png') }} " alt="Blue Tick">
            </h3>
            <ul class="d-flex flex-wrap fs-6 align-items-center">
              <li class="me-3 d-inline-flex align-items-center">
                <i class="las la-user me-1 fs-18"></i>Web Designer
              </li>
              <li class="me-3 d-inline-flex align-items-center">
                <i class="las la-map-marker me-1 fs-18"></i>420 City Path, AU 123-456
              </li>
              <li class="me-3 d-inline-flex align-items-center">
                <i class="las la-envelope me-1 fs-18"></i>info@gmail.com
              </li>
            </ul>
          ...
          <div class="clearfix mt-3 mt-xl-0 ms-auto d-flex flex-column col-xl-3">
            <div class="clearfix mb-3 text-xl-end">
              <a href="javascript:void(0);" class="btn btn-light">Follow</a>
      ...
      <div class="card-footer py-0 d-flex flex-wrap justify-content-between align-items-center">
        <ul class="nav nav-underline nav-underline-primary nav-underline-text-dark nav-underline-gap-x-0" id="tabMyProfileBottom" role="tablist">
          <li class="nav-item ms-1" role="presentation">
            <a href="{{ url('account/overview') }}" class="nav-link py-3 border-3 text-dark">Overview</a>
          </li>
          <li class="nav-item ms-1" role="presentation">
            <a href="{{ url('account/settings') }}" class="nav-link py-3 border-3 text-dark active">Settings</a>
          </li>
          <li class="nav-item ms-1" role="presentation">
            <a href="{{ url('account/security') }}" class="nav-link py-3 border-3 text-dark">Security</a>
          </li>
          <li class="nav-item ms-1" role="presentation">
            <a href="{{ url('account/activity') }}" class="nav-link py-3 border-3 text-dark">Activity</a>
          </li>
          <li class="nav-item ms-1" role="presentation">
            <a href="{{ url('account/billing') }}" class="nav-link py-3 border-3 text-dark">Billing</a>
          </li>
          <li class="nav-item ms-1" role="presentation">
            <a href="{{ url('account/statements') }}" class="nav-link py-3 border-3 text-dark">Statements</a>
          </li>
          <li class="nav-item ms-1" role="presentation">
            <a href="{{ url('account/referrals') }}" class="nav-link py-3 border-3 text-dark">Referrals</a>
          </li>
          <li class="nav-item ms-1" role="presentation">
            <a href="{{ url('account/api-keys') }}" class="nav-link py-3 border-3 text-dark">API Keys</a>
          </li>
          <li class="nav-item ms-1" role="presentation">
            <a href="{{ url('account/logs') }}" class="nav-link py-3 border-3 text-dark">Logs</a>
          </li>
        </ul>
        ...
        <div class="col-xl-8">
          <div class="card">
                  ...
                  <div class="col-md-9">
                    <div class="d-inline-block position-relative me-4 mb-3 mb-lg-0 account-profile">
                      <div class="avatar-preview rounded">
                        <div id="imagePreview" class="rounded-4 profile-avatar" style="background-image: url({{ asset('images/avatar/pic7.jpg') }} );"></div>
                      </div>
            ...
            <div class="card-footer text-end">
              ...
              <a href="javascript:void(0);" class="btn btn-primary ms-2 mb-2">Save Changes</a>
            </div>
          </div>
        </div>
        <div class="col-xl-4">
          <div class="row">
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="alert alert-primary border-primary outline-dashed py-3 px-3 mt-1 mb-3 mb-0 text-dark d-flex">
                    <div class="clearfix">
                      <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path opacity="0.3" fill-rule="evenodd" clip-rule="evenodd" d="M27.75 12C29.8211 12 31.5 10.3211 31.5 8.25C31.5 6.17893 29.8211 4.5 27.75 4.5C25.6789 4.5 24 6.17893 24 8.25C24 10.3211 25.6789 12 27.75 12ZM27.75 31.5C29.8211 31.5 31.5 29.8211 31.5 27.75C31.5 25.6789 29.8211 24 27.75 24C25.6789 24 24 25.6789 24 27.75C24 29.8211 25.6789 31.5 27.75 31.5ZM12 27.75C12 29.8211 10.3211 31.5 8.25 31.5C6.17893 31.5 4.5 29.8211 4.5 27.75C4.5 25.6789 6.17893 24 8.25 24C10.3211 24 12 25.6789 12 27.75Z" fill="var(--primary)" />
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M8.25 12C10.3211 12 12 10.3211 12 8.25C12 6.17893 10.3211 4.5 8.25 4.5C6.17893 4.5 4.5 6.17893 4.5 8.25C4.5 10.3211 6.17893 12 8.25 12ZM15 7C15 6.44772 15.4477 6 16 6H20C20.5523 6 21 6.44772 21 7V8C21 8.55229 20.5523 9 20 9H16C15.4477 9 15 8.55229 15 8V7ZM16 27C15.4477 27 15 27.4477 15 28V29C15 29.5523 15.4477 30 16 30H20C20.5523 30 21 29.5523 21 29V28C21 27.4477 20.5523 27 20 27H16ZM6 16C6 15.4477 6.44772 15 7 15H8C8.55229 15 9 15.4477 9 16V20C9 20.5523 8.55229 21 8 21H7C6.44772 21 6 20.5523 6 20V16ZM28 15C27.4477 15 27 15.4477 27 16V20C27 20.5523 27.4477 21 28 21H29C29.5523 21 30 20.5523 30 20V16C30 15.4477 29.5523 15 29 15H28Z" fill="var(--primary)" />
                      </svg>
                    </div>
                    <div class="mx-3"> Two-factor authentication adds an extra layer of security to your account. To log in, in you'll need to provide a 4 digit amazing code <a href="javascript:void(0);" class="text-primary">Learn More</a>
                    </div>
                  </div>
                  <div class="d-flex align-items-center border-bottom border-light py-3">
                    ...
                    <div class="clearfix ms-auto">
                      <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchGoogle" checked="">
                      </div>
                    </div>
                  </div>
                  <div class="d-flex align-items-center border-bottom border-light py-3">
                    <div class="avatar avatar-md rounded d-flex align-items-center justify-content-center bg-white">
                      <img src="{{ asset('images/logo/github.png') }} " alt="">
                    </div>
                    <div class="clearfix ms-2">
                    ...
                    <div class="clearfix ms-auto">
                      <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchGithub" checked="">
                      </div>
                    </div>
                  </div>
                  <div class="d-flex align-items-center py-3">
                    <div class="avatar avatar-md d-flex align-items-center justify-content-center bg-white">
                    ...
                    <div class="clearfix ms-auto">
                      <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchSlack">
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <form action="#" class="mt-2">
                    <div class="clearfix border-bottom border-light py-3">
                      <div class="row align-items-center">
                        ...
                        <div class="col-sm-3 col-6">
                          <div class="form-check custom-checkbox me-4 mb-0 d-inline-block">
                            <input type="checkbox" class="form-check-input mb-0" id="checkboxNotEmail" required="">
                            <label class="form-check-label mb-0" for="checkboxNotEmail">Email</label>
                          </div>
                        </div>
                        <div class="col-sm-3 col-6">
                          <div class="form-check custom-checkbox me-4 mb-0 d-inline-block">
                            <input type="checkbox" class="form-check-input mb-0" id="checkboxNotPhone" required="">
                            <label class="form-check-label mb-0" for="checkboxNotPhone">Phone</label>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="clearfix border-bottom border-light py-3">
                      <div class="row align-items-center">
                        ...
                        <div class="col-sm-3 col-6">
                          <div class="form-check custom-checkbox me-4 mb-0 d-inline-block">
                            <input type="checkbox" class="form-check-input mb-0" id="checkboxBillEmail" required="">
                            <label class="form-check-label mb-0" for="checkboxBillEmail">Email</label>
                          </div>
                        </div>
                        <div class="col-sm-3 col-6">
                          <div class="form-check custom-checkbox me-4 mb-0 d-inline-block">
                            <input type="checkbox" class="form-check-input mb-0" id="checkboxBillPhone" required="">
                            <label class="form-check-label mb-0" for="checkboxBillPhone">Phone</label>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="clearfix border-bottom border-light py-3">
                      <div class="row align-items-center">
                        ...
                        <div class="col-sm-3 col-6">
                          <div class="form-check custom-checkbox me-4 mb-0 d-inline-block">
                            <input type="checkbox" class="form-check-input mb-0" id="checkboxTeamEmail" required="">
                            <label class="form-check-label mb-0" for="checkboxTeamEmail">Email</label>
                          </div>
                        </div>
                        <div class="col-sm-3 col-6">
                          <div class="form-check custom-checkbox me-4 mb-0 d-inline-block">
                            <input type="checkbox" class="form-check-input mb-0" id="checkboxTeamPhone" required="">
                            <label class="form-check-label mb-0" for="checkboxTeamPhone">Phone</label>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="clearfix border-bottom border-light py-3">
                      <div class="row align-items-center">
                        ...
                        <div class="col-sm-3 col-6">
                          <div class="form-check custom-checkbox me-4 mb-0 d-inline-block">
                            <input type="checkbox" class="form-check-input mb-0" id="checkboxProEmail" required="">
                            <label class="form-check-label mb-0" for="checkboxProEmail">Email</label>
                          </div>
                        </div>
                        <div class="col-sm-3 col-6">
                          <div class="form-check custom-checkbox me-4 mb-0 d-inline-block">
                            <input type="checkbox" class="form-check-input mb-0" id="checkboxProPhone" required="">
                            <label class="form-check-label mb-0" for="checkboxProPhone">Phone</label>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="clearfix py-3">
                      <div class="row align-items-center">
                        ...
                        <div class="col-sm-3 col-6">
                          <div class="form-check custom-checkbox me-4 mb-0 d-inline-block">
                            <input type="checkbox" class="form-check-input mb-0" id="checkboxNewsEmail" required="">
                            <label class="form-check-label mb-0" for="checkboxNewsEmail">Email</label>
                          </div>
                        </div>
                        <div class="col-sm-3 col-6">
                          <div class="form-check custom-checkbox me-4 mb-0 d-inline-block">
                            <input type="checkbox" class="form-check-input mb-0" id="checkboxNewsPhone" required="">
                            <label class="form-check-label mb-0" for="checkboxNewsPhone">Phone</label>
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            <div class="card-body">
              <div class="alert alert-warning border-warning outline-dashed py-3 px-3 mt-1 mb-4 mb-0 text-dark d-flex align-items-center">
                ...
                <div class="mx-3">
                  ...
                  <p class="mb-0">For extra security, this requires you to confirm your email or phone number when you reset your password. <a href="javascript:void(0);" class="text-warning">Learn More</a>
                  </p>
                </div>
              </div>
              <div class="form-check custom-checkbox me-4 my-3 d-inline-block">
                ...
                <label class="form-check-label mb-0" for="checkboxDeactivation">Confirm Account Deactivation</label>
              </div>
            </div>
            <div class="card-footer text-end">
