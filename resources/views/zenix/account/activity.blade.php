    ...
    <div class="card profile-overview">
      ...
      <div class="card-footer py-0 d-flex flex-wrap justify-content-between align-items-center">
        <ul class="nav nav-underline nav-underline-primary nav-underline-text-dark nav-underline-gap-x-0" id="tabMyProfileBottom" role="tablist">
          ...
          <li class="nav-item ms-1" role="presentation">
            <a href="{{ url('account/activity') }}" class="nav-link py-3 border-3 text-dark active">Activity</a>
          </li>
          <li class="nav-item ms-1" role="presentation">
        ...
        <div class="col-xxl-12 col-xl-8">
          <div class="card">
            <div class="card-header py-3 d-block d-sm-flex">
              ...
              <ul class="nav nav-pills mt-3 mt-sm-0" id="myTab" role="tablist">
                <li class="nav-item ms-1" role="presentation">
                  <button class="nav-link btn btn-light active" id="week-tab3" data-bs-toggle="tab" data-bs-target="#tabWeek3" type="button" role="tab" aria-selected="true">Week</button>
                </li>
                <li class="nav-item ms-1" role="presentation">
                  <button class="nav-link btn btn-light" id="month-tab3" data-bs-toggle="tab" data-bs-target="#tabMonth3" type="button" role="tab" aria-selected="false" tabindex="-1">Month</button>
                </li>
                <li class="nav-item ms-1" role="presentation">
                  <button class="nav-link btn btn-light" id="year-tab3" data-bs-toggle="tab" data-bs-target="#tabYear3" type="button" role="tab" aria-selected="false" tabindex="-1">Year</button>
                </li>
                <li class="nav-item ms-1" role="presentation">
                  <button class="nav-link btn btn-light" id="all-tab3" data-bs-toggle="tab" data-bs-target="#tabAll3" type="button" role="tab" aria-selected="false" tabindex="-1">All</button>
                </li>
              </ul>
            </div>
            <div class="card-body">
                    ...
                    <ul class="timeline">
                      <li>
                        ...
                        <div class="timeline-panel">
                          <div class="clearfix">
                            ...
                            <span class="fs-14 d-block">3:30 PM by <span class="text-primary">You</span>
                            </span>
                          </div>
                          <div class="px-3 py-3 mt-3 border border-secondary border-opacity-10 rounded">
                            <div class="row align-items-center">
                              <div class="col-xl-6 col-xxl-5 col-lg-12 mb-3 mb-xl-0">
                              ...
                              <div class="col-xl-2 col-sm-3 col-6">
                                <div class="avatar-list avatar-list-stacked ms-3">
                                  <img src="{{ asset('images/avatar/3.jpg') }} " alt="" class="avatar avatar-sm rounded-circle">
                                  <img src="{{ asset('images/avatar/4.jpg') }} " alt="" class="avatar avatar-sm rounded-circle">
                              ...
                              <div class="col-xl-1 col-xxl-2 col-sm-3 col-6 mt-2 mt-sm-0">
                                <span class="badge badge-sm badge-info light border-0">In Progress</span>
                              </div>
                              <div class="col-xl-1 col-sm-3 col-6 text-end mt-2 mt-sm-0">
                      ...
                      <li>
                        ...
                        <div class="timeline-panel">
                          <div class="clearfix">
                            ...
                            <span class="fs-14 d-block">04:12 PM by <span class="text-primary">Jackson</span>
                            </span>
                          </div>
                        </div>
                      </li>
                      <li>
                        ...
                        <div class="timeline-panel">
                          <div class="clearfix">
                            ...
                            <span class="fs-14 d-block">12:25 PM by <span class="text-primary">You</span>
                            </span>
                          </div>
                          <div class="p-md-4 p-3 mt-3 border border-secondary border-opacity-10 rounded">
                            <div class="row g-3">
                              <div class="col-lg-3 col-sm-6">
                                <div class="d-flex align-items-center">
                                  <div class="me-3">
                                    <img src="{{ asset('images/files/pdf.png') }} " width="35" alt="">
                                  </div>
                                  <div class="clearfix">
                                    <h6 class="mb-0 fs-14">Airplus Guideline</h6>
                              ...
                              <div class="col-lg-3 col-sm-6">
                                <div class="d-flex align-items-center">
                                  <div class="me-3">
                                    <img src="{{ asset('images/files/csv.png') }} " width="35" alt="">
                                  </div>
                                  <div class="clearfix">
                                    <h6 class="mb-0 fs-14">FureStibe requirements</h6>
                              ...
                              <div class="col-lg-3 col-sm-6">
                                <div class="d-flex align-items-center">
                                  <div class="me-3">
                                    <img src="{{ asset('images/files/css.png') }} " width="35" alt="">
                                  </div>
                                  <div class="clearfix">
                                    <h6 class="mb-0 fs-14">FureStibe styles</h6>
                        ...
                        <div class="timeline-panel">
                          <div class="clearfix">
                            <span class="fs-14 fw-semibold">
                              <a href="javascript:void(0);" class="text-primary fw-medium">jQuery.js</a> was merged into <strong>Google</strong> Task task </span>
                            <span class="fs-14 d-block">12:38 PM by <span class="text-primary">Jogn Walles</span>
                            </span>
                          </div>
                        </div>
                      </li>
                      <li>
                        ...
                        <div class="timeline-panel">
                          <div class="clearfix">
                            <span class="fs-14 fw-semibold">
                              <strong>Hughes</strong> Created & assigned a new task <a href="javascript:void(0);" class="text-primary">Design Multistep Registraion Form</a> to you </span>
                            <span class="fs-14 d-block">11:02 PM by <span class="text-primary">Hughes</span>
                            </span>
                          </div>
                        </div>
                      </li>
                      <li>
                        ...
                        <div class="timeline-panel">
                          <div class="clearfix">
                            ...
                            <span class="fs-14 d-block">1:56 PM by <span class="text-primary">You</span>
                            </span>
                          </div>
                          <div class="p-md-4 p-3 mt-3 border border-secondary border-opacity-10 rounded">
                            <div class="row g-3">
                              <div class="col-md-2 col-4">
                                <img src="{{ asset('images/blog/screen1.jpg') }} " alt="" class="w-100 rounded">
                              </div>
                              <div class="col-md-2 col-4">
                                <img src="{{ asset('images/blog/screen2.jpg') }} " alt="" class="w-100 rounded">
                              </div>
                              <div class="col-md-2 col-4">
                                <img src="{{ asset('images/blog/screen3.jpg') }} " alt="" class="w-100 rounded">
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <li>
                        ...
                        <div class="timeline-panel">
                          <div class="clearfix">
                            <span class="fs-14 fw-semibold">
                              <strong>Hughes</strong> Fold Created & assigned a new task <a href="javascript:void(0);" class="text-primary">Design Multistep Registraion Form</a> to you </span>
                            <span class="fs-14 d-block">11:02 PM by <span class="text-primary">Hughes</span>
                            </span>
                          </div>
                        </div>
                      ...
                      <li>
                        ...
                        <div class="timeline-panel">
                          <div class="clearfix">
                            ...
                            <span class="fs-14 d-block">2:08 PM by <span class="text-primary">DexignZone Team</span>
                            </span>
                          </div>
                          <div class="row">
                            <div class="col-lg-8">
                              <div class="alert alert-primary border-primary outline-dashed py-3 px-4 d-flex align-items-center mb-0 mt-3">
                                ...
                                <div class="mx-3">
                                  <h6 class="fs-14 fw-semibold mb-1">Withdraw Your Funds to Bank</h6>
                                  <p class="fs-14 mb-0 text-dark">Securely withdraw money to your bank account, with a $25 fee.</p>
                                </div>
                              </div>
                            </div>
                          </div>
