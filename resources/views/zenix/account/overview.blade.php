      ...
      <div class="card-footer py-0 d-flex flex-wrap justify-content-between align-items-center">
        <ul class="nav nav-underline nav-underline-primary nav-underline-text-dark nav-underline-gap-x-0" id="tabMyProfileBottom" role="tablist">
          <li class="nav-item ms-1" role="presentation">
            <a href="{{ url('account/overview') }}" class="nav-link py-3 border-3 text-dark active">Overview</a>
          </li>
          <li class="nav-item ms-1" role="presentation">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="row py-2">
                ...
                <div class="col-6">
                  <span class="fs-13 fw-semibold">Email, Phone</span>
                </div>
              </div>
              <div class="row py-2">
                <div class="col-6">
              ...
              <div class="alert alert-warning border-warning outline-dashed py-3 px-3 mt-4 mb-0 text-dark d-flex align-items-center">
                <div class="clearfix">
                ...
                <div class="mx-3">
                  ...
                  <p class="mb-0 fs-13">Your Payment was declined. To start using tools, please <a href="javascript:void(0);" class="text-warning">Add Payment Method</a>
                  </p>
                </div>
              </div>
            </div>
                ...
                <table class="table mb-1 table-striped-thead table-wide table-md table-border-last-0">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Nov 01, 2020</td>
                      <td>
                        <span class="badge badge-sm badge-success light border-0">In Stock</span>
                      </td>
                      <td>$1,120</td>
                    ...
                    <tr>
                      ...
                      <td>Sep 27, 2020</td>
                      <td>
                        <span class="badge badge-sm badge-danger light border-0">Out of Stock</span>
                      </td>
                      <td>$440</td>
