    ...
    <div class="card profile-overview">
      ...
      <div class="card-footer py-0 d-flex flex-wrap justify-content-between align-items-center">
        <ul class="nav nav-underline nav-underline-primary nav-underline-text-dark nav-underline-gap-x-0" id="tabMyProfileBottom" role="tablist">
          ...
          <li class="nav-item ms-1" role="presentation">
            <a href="{{ url('account/security') }}" class="nav-link py-3 border-3 text-dark active">Security</a>
          </li>
          <li class="nav-item ms-1" role="presentation">
              ...
              <div class="d-flex justify-content-between">
                ...
                <ul class="nav chart-summary-tab nav-pills" role="tablist">
                  <li class="nav-item ms-1">
                    <a class="nav-link btn btn-light  active" data-series="agents" data-bs-toggle="tab" href="#summaryAgents" role="tab">Agents</a>
                  </li>
                  <li class="nav-item ms-1">
                    <a class="nav-link btn btn-light" data-series="clients" data-bs-toggle="tab" href="#summaryClients" role="tab">Clients</a>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div class="card">
                <div class="card-body p-4">
                  <div class="owl-carousel owl-theme card-carousel card-carousel-dots p-2 pt-3">
                    <div class="item">
                      <span class="fs-14 mb-3 d-block">Recent Alerts</span>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-body">
                  <div class="owl-carousel owl-theme card-carousel card-carousel-dots p-2 pt-3">
                    <div class="item">
                      <span class="fs-14 mb-3 d-block">Security Guidelines</span>
              ...
              <div class="table-responsive">
                <table class="table mb-1 table-striped-thead table-wide table-sm" id="tableLicenseUsage">
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <span class="badge badge-sm badge-success light border-0">License</span>
                      </td>
                      ...
                      <td>
                        <div class="select-text-wrap d-flex justify-content-between">
                          ...
                          <button class="btn-select-text btn p-0 border-0 ms-4">
                            <i class="las la-copy fs-4"></i>
                            <span>Copy</span>
                          </button>
                        </div>
                      </td>
                    ...
                    <tr>
                      <td>
                        <span class="badge badge-sm badge-danger light border-0">Unknown</span>
                      </td>
                    ...
                    <tr>
                      <td>
                        <span class="badge badge-sm badge-warning light border-0">To be Paid</span>
                      </td>
...
$('.btn-select-text').on('click', function(){
    ...
    setTimeout(function() {
        $span.text(originalText); // Revert back to the original text after 2 seconds
    }, 2000);
});
