          ...
          <div class="card-body chat-wrapper p-0">
            ...
            <div class="chat-left-sidebar">
              <div class="d-flex chat-fix-search align-items-center">
                <img src="{{ asset('images/profile/pic1.jpg') }} " alt="" class="rounded-circle me-3">
              ...
              <div class="card-action card-tabs">
                <ul class="nav nav-tabs style-3" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" data-bs-toggle="tab" href="#AllMessage" role="tab" aria-selected="false"> All Message </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="tab" href="#Unread" role="tab" aria-selected="false"> Unread </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link " data-bs-toggle="tab" href="#Archived" role="tab" aria-selected="true"> Archived </a>
                  </li>
                </ul>
              </div>
                ...
                <div class="tab-content dz-scroll" id="message-bx">
                  <div class="tab-pane fade show active" id="AllMessage" role="tabpanel">
                    <div class="chat-list-area" data-chat="person1">
                      <div class="image-bx">
                        <img src="{{ asset('images/users/pic1.jpg') }} " alt="" class="rounded-circle img-1">
                    ...
                    <div class="chat-list-area active" data-chat="person2">
                      <div class="image-bx">
                        <img src="{{ asset('images/users/pic2.jpg') }} " alt="" class="rounded-circle img-1">
                        <span class="active"></span>
                      </div>
                      <div class="info-body">
                        <div class="d-flex">
                    ...
                    <div class="chat-list-area" data-chat="person3">
                      <div class="image-bx">
                        <img src="{{ asset('images/users/pic3.jpg') }} " alt="" class="rounded-circle img-1">
                        <span class="active"></span>
                      </div>
                      <div class="info-body">
                        <div class="d-flex">
                    ...
                    <div class="chat-list-area" data-chat="person4">
                      <div class="image-bx">
                        <img src="{{ asset('images/users/pic4.jpg') }} " alt="" class="rounded-circle img-1">
                      </div>
                      <div class="info-body">
                        <div class="d-flex">
                    ...
                    <div class="chat-list-area" data-chat="person5">
                      <div class="image-bx">
                        <img src="{{ asset('images/users/pic5.jpg') }} " alt="" class="rounded-circle img-1">
                      </div>
                      <div class="info-body">
                        <div class="d-flex">
                    ...
                    <div class="chat-list-area" data-chat="person6">
                      <div class="image-bx">
                        <img src="{{ asset('images/users/pic6.jpg') }} " alt="" class="rounded-circle img-1">
                      </div>
                      <div class="info-body">
                        <div class="d-flex">
                    ...
                    <div class="chat-list-area" data-chat="person7">
                      <div class="image-bx">
                        <img src="{{ asset('images/users/pic7.jpg') }} " alt="" class="rounded-circle img-1">
                      </div>
                      <div class="info-body">
                        <div class="d-flex">
                    ...
                    <div class="chat-list-area" data-chat="person8">
                      <div class="image-bx">
                        <img src="{{ asset('images/users/pic8.jpg') }} " alt="" class="rounded-circle img-1">
                      </div>
                      <div class="info-body">
                        <div class="d-flex">
              ...
              <div class="message-bx chat-box">
                <div class="d-flex justify-content-between chat-box-header">
                  <div class="d-flex align-items-center">
                    <img src="{{ asset('images/users/pic2.jpg') }} " alt="" class="rounded-circle main-img me-3">
                ...
                <div class="chat-box-area dz-scroll" id="chartBox" style="background-image:url('{{ asset('images/chat-bg.png') }} ');">
                  <div data-chat="person1" class="chat">
                    <div class="media mb-4 received-msg  justify-content-start align-items-start">
                      ...
                      <div class="message-received">
                        <p class="mb-1"> Sed ut perspiciatis unde omnis iste natus error </p>
                        <span class="fs-12 text-black">4.30 AM</span>
                      </div>
                    </div>
                    <div class="media mb-4 justify-content-end align-items-end">
                      <div class="message-sent">
                        <p class="mb-1"> Neque porro quisquam est, qui dolorem ipsum quia </p>
                        <span class="fs-12 text-black">9.30 AM</span>
                      </div>
                      <div class="image-bx ms-sm-3 ms-2 mb-4">
                        <img src="{{ asset('images/profile/pic1.jpg') }} " alt="" class="rounded-circle img-1">
                      </div>
                    </div>
                    <div class="media mb-4  justify-content-end align-items-end">
                      <div class="message-sent">
                        <p class="mb-1"> eum iure reprehenderit qui in ea </p>
                        <span class="fs-12 text-black">9.30 AM</span>
                      </div>
                      <div class="image-bx ms-sm-3 ms-2 mb-4">
                        <img src="{{ asset('images/profile/pic1.jpg') }} " alt="" class="rounded-circle img-1">
                    ...
                    <div class="media received-msg justify-content-start align-items-start">
                      ...
                      <div class="message-received">
                        <p class="mb-1"> Hey, check my design update last night. </p>
                        <span class="fs-12 text-black">4.30 AM</span>
                      </div>
                    </div>
                  </div>
                  <div data-chat="person2" class="chat active-chat">
                    <div class="media mb-4 received-msg  justify-content-start align-items-start">
                      ...
                      <div class="message-received">
                        <p class="mb-1"> "But I must explain to you </p>
                        <span class="fs-12 text-black">4.30 AM</span>
                      </div>
                    </div>
                    <div class="media mb-4 justify-content-end align-items-end">
                      <div class="message-sent">
                        <p class="mb-1"> "Sed ut perspiciatis unde omnis </p>
                        <span class="fs-12 text-black">9.30 AM</span>
                      </div>
                      <div class="image-bx ms-sm-3 ms-2 mb-4">
                        <img src="{{ asset('images/profile/pic1.jpg') }} " alt="" class="rounded-circle img-1">
                    ...
                    <div class="media received-msg justify-content-start align-items-start">
                      ...
                      <div class="message-received">
                        <p class="mb-1">Tell me what you think and if that is OK. </p>
                        <span class="fs-12 text-black">4.30 AM</span>
                      </div>
                    </div>
                  </div>
                  <div data-chat="person3" class="chat">
                    <div class="media mb-4 received-msg  justify-content-start align-items-start">
                      ...
                      <div class="message-received">
                        <p class="mb-1"> On the other hand, we denounce with righteous </p>
                        <span class="fs-12 text-black">4.30 AM</span>
                      </div>
                    </div>
                    <div class="media mb-4 justify-content-end align-items-end">
                      <div class="message-sent">
                        <p class="mb-1"> These cases are perfectly simple and easy to distinguish. </p>
                        <span class="fs-12 text-black">9.30 AM</span>
                      </div>
                      <div class="image-bx ms-sm-3 ms-2 mb-4">
                        <img src="{{ asset('images/profile/pic1.jpg') }} " alt="" class="rounded-circle img-1">
                    ...
                    <div class="media mb-4 justify-content-end align-items-end">
                      <div class="message-sent">
                        <p class="mb-1"> In a free hour, when our power of choice </p>
                        <span class="fs-12 text-black">9.30 AM</span>
                      </div>
                      <div class="image-bx ms-sm-3 ms-2 mb-4">
                        <img src="{{ asset('images/profile/pic1.jpg') }} " alt="" class="rounded-circle img-1">
                  ...
                  <div data-chat="person4" class="chat"></div>
                  <div data-chat="person5" class="chat"></div>
                  <div data-chat="person6" class="chat"></div>
                  <div data-chat="person7" class="chat"></div>
                  <div data-chat="person8" class="chat"></div>
                  <div data-chat="person9" class="chat"></div>
                  <div data-chat="person10" class="chat"></div>
                  <div data-chat="person11" class="chat"></div>
                  <div data-chat="person12" class="chat"></div>
                  <div data-chat="person13" class="chat"></div>
                  <div data-chat="person14" class="chat"></div>
                </div>
                <div class="card-footer border-0 type-massage">
                  <div class="input-group">
                    <input class="form-control" placeholder="Type message..." />
                    <div class="input-group-append">
                      <button type="button" class="btn p-0 me-3">
                        <i class="las la-paperclip scale5 text-secondary"></i>
                      </button>
                      <button type="button" class="btn p-0 me-3">
                        <i class="las la-image scale5 text-secondary"></i>
                      </button>
