...
<div class="content-body">
  <div class="container-fluid">
    <div class="row page-titles">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
          <a href="javascript:void(0);">Add Email</a>
        </li>
      </ol>
    </div>
    <!-- Row -->
    <div class="row">
      <div class="col-xl-12">
        <a href="{{ url('cms/email-template') }}" class="btn btn-sm btn-primary mb-4">List Email Template</a>
      </div>
      <div class="col-xl-12">
          ...
          <div class="cm-content-body form excerpt">
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-xl-12">
                  <label class="form-label btn-sm mx-1">Email Template</label>
