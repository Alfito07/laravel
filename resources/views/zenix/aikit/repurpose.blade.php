    ...
    <div class="row page-titles">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
          <a href="javascript:void(0);">Repurpose</a>
        </li>
      </ol>
    </div>
    <div class="row">
      <div class="col-xl-12">
        ...
        <ul class="nav nav-tabs style-1 mb-4" id="pills-tab" role="tablist">
          ...
          <li class="nav-item" role="presentation">
            <a href="{{ url('aikit/repurpose') }}" class="nav-link active border-s-1">Repurpose</a>
          </li>
          <li class="nav-item" role="presentation">
        ...
        <div class="card h-auto">
          <div class="card-body ai-tabs-1 py-2">
            <ul class="nav nav-tabs align-items-end" id="myTab" role="tablist">
              ...
              <li class="nav-item" role="presentation">
                <button class="nav-link" id="jobs-tab" data-bs-toggle="tab" data-bs-target="#jobs-tab-pane" type="button" role="tab" aria-controls="jobs-tab-pane" aria-selected="false">Jobs <span class="badge badge-circle badge-light light ms-2">5</span>
                </button>
              </li>
            </ul>
          </div>
                ...
                <div class="card overflow-hidden h-auto">
                  <div class="card-header border-0 pb-0">
                    ...
                    <select class="form-control custom-image-select ai-select image-select">
                      <option data-thumbnail="{{ asset('images/svg/england.svg') }} ">England</option>
                      <option data-thumbnail="{{ asset('images/svg/india.svg') }} ">India</option>
                      <option data-thumbnail="{{ asset('images/svg/united-arab-emirates.svg') }} ">UAE</option>
                    </select>
                  </div>
                  <div class="card-body pb-0 pt-3">
                    <div class="mb-3">
                      ...
                      <div class="my-2 d-flex align-items-center flex-wrap">
                        <a href="javascript:void(0);" class=" btn btn-outline-primary mb-2 me-3">
                          ...
                          </svg> Post or article </a>
                        <a href="javascript:void(0);" class=" btn btn-outline-primary mb-2">
                          <svg width="19" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="card">
              <div class="card-body">
                <div class="table-responsive active-projects style-1">
                  <table id="empoloyees-tblwrapper" class="table empoloyees-table">
                    <thead>
                      <tr>
                        <th>URL</th>
                        <th>Job Type</th>
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <a href="javascript:void(0);">www.wsj.com/articles/harvard-discriminates-against-middle-class-kids-legacy-admissions-court-85cf4503</a>
                        </td>
                        <td> URL </td>
                        <td>-</td>
                        <td>
