    ...
    <div class="row page-titles">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
          <a href="javascript:void(0);">Auto Writer</a>
        </li>
      </ol>
    </div>
    <div class="row">
      <div class="col-xl-12">
        <div class="alert alert-dismissible ai-header-alert fade show mb-4"> This is a demo of AIKit plugin made for you to test the experience of using the plugin. Text & images generated in this demo are dummy. In real life, AIKit will call OpenAI API and generate relevant text and images based on your prompts. <button type="button" class="btn-close ms-auto" data-bs-dismiss="alert" aria-label="btn-close">
        ...
        <ul class="nav nav-tabs style-1 mb-4" id="pills-tab" role="tablist">
          <li class="nav-item" role="presentation">
            <a href="{{ url('aikit/auto-write') }}" class="nav-link active border-s-1">Auto Writer</a>
          </li>
          <li class="nav-item" role="presentation">
...
Write a brief description of the topic you want to write about...
                    ...
                    <div class="btn-group d-block card-length" role="group" aria-label="Basic checkbox toggle button group">
                      ...
                      <label class="btn btn-outline-primary btn-sm rounded form-label me-1" for="btncheck1">Include outline</label>
                      <input type="checkbox" class="btn-check" id="btncheck2">
                      <label class="btn btn-outline-primary btn-sm rounded form-label me-1" for="btncheck2">Include conclusion</label>
                      <input type="checkbox" class="btn-check" id="btncheck3">
                      <label class="btn btn-outline-primary btn-sm rounded form-label me-1" for="btncheck3">Include TL;DR</label>
                      <input type="checkbox" class="btn-check  me-1" id="btncheck4">
                      <label class="btn btn-outline-primary btn-sm rounded form-label me-1" for="btncheck4">Include featured article Image3</label>
                      <input type="checkbox" class="btn-check" id="btncheck5">
                      <label class="btn btn-outline-primary btn-sm rounded form-label" for="btncheck5">Include section images</label>
                    </div>
            ...
            <div class="card h-auto">
              <div class="card-body p-0">
                <div class="table-responsive ai-table">
                  <table class="table table-responsive-md border-collapse-separate table-space">
                    <thead>
                      <tr>
