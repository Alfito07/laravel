...
<div class="content-body">
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-xl-12">
        <div class="alert alert-dismissible ai-header-alert fade show mb-5"> This is a demo of AIKit plugin made for you to test the experience of using the plugin. <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="btn-close">
            <span>
        ...
        <ul class="nav nav-tabs style-1 mb-4" id="pills-tab" role="tablist">
          ...
          <li class="nav-item" role="presentation">
            <a href="{{ url('aikit/chatbot') }}" class="nav-link active border-s-1">Chatbot</a>
          </li>
          <li class="nav-item" role="presentation">
            ...
            <div class="row">
              ...
              <div class="col-xl-12">
                ...
                <div class="form-check">
                  ...
                  <label class="form-check-label" for="flexCheckDefault"> Page content aware? </label>
                </div>
                <div id="emailHelp-4" class="form-text">If enabled, the chatbot will be able to use the content of the current page to generate better responses. Important: it will increase your API costs! </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              ...
              <div class="col-xl-2 col-sm-4">
                <div class="example style-1">
                  ...
                  <input type="text" class="complex-colorpicker form-control d-none" value="var(--primary)">
                </div>
              </div>
              <div class="col-xl-2 col-sm-4">
                <div class="example style-1">
