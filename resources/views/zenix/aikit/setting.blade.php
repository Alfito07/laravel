    ...
    <div class="row">
      <div class="col-xl-12">
        ...
        <ul class="nav nav-tabs style-1 mb-4" id="pills-tab" role="tablist">
          ...
          <li class="nav-item" role="presentation">
            <a href="{{ url('aikit/setting') }}" class="nav-link active border-s-1">Settings</a>
          </li>
          <li class="nav-item" role="presentation">
              ...
              <div class="col-xl-3 col-sm-6">
                ...
                <div class="ai-check">
                  <div class="form-check mb-0">
                    ...
                    <label class="form-check-label mb-0" for="flexCheckDefault"> Elementor supported? </label>
                  </div>
                </div>
              ...
              <div class="col-xl-3 col-sm-6">
                ...
                <div class="ai-check bg-grey">
                  <div class="form-check mb-0">
                    ...
                    <label class="form-check-label text-white mb-0" for="flexCheckDefault-1"> Small (256x256) </label>
                  </div>
                </div>
              ...
              <div class="col-xl-3 col-sm-6 align-self-end">
                <div class="ai-check bg-grey">
                  <div class="form-check mb-0">
                    ...
                    <label class="form-check-label text-white mb-0" for="flexCheckDefault-2"> Medium (512x512) </label>
                  </div>
                </div>
              ...
              <div class="col-xl-3 col-sm-6 align-self-end">
                <div class="ai-check">
                  <div class="form-check mb-0">
                    ...
                    <label class="form-check-label mb-0" for="flexCheckDefault-3"> Large (1024x1204) </label>
                  </div>
                </div>
