    ...
    <div class="row page-titles">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
          <a href="javascript:void(0);">Fine-tune Models</a>
        </li>
      </ol>
    </div>
    <div class="row">
      <div class="col-xl-12">
        <div class="alert alert-dismissible ai-header-alert fade  show mb-5" role="alert"> This is a demo of AIKit plugin made for you to test the experience of using the plugin. Text & images generated in this demo are dummy. In real life, AIKit will call OpenAI API and generate relevant text and images based on your prompts. <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close">
        ...
        <ul class="nav nav-tabs style-1 mb-4" id="pills-tab" role="tablist">
          ...
          <li class="nav-item" role="presentation">
            <a href="{{ url('aikit/fine-tune-models') }}" class="nav-link active border-s-1">Fine-tune Models</a>
          </li>
          <li class="nav-item" role="presentation">
        ...
        <div class="card h-auto">
          <div class="card-body ai-tabs-1 py-2">
            <ul class="nav nav-tabs align-items-end" id="myTab" role="tablist">
              ...
              <li class="nav-item" role="presentation">
                <button class="nav-link active" id="jobs-tab" data-bs-toggle="tab" data-bs-target="#jobs-tab-pane" type="button" role="tab" aria-controls="jobs-tab-pane" aria-selected="false">Jobs <span class="badge badge-circle badge-light light ms-2">5</span>
                </button>
              </li>
            </ul>
          </div>
                  ...
                  <div class="card-body pb-0">
                    <div class="mb-3">
                      ...
                      <div class="mt-2 d-flex align-items-center flex-wrap">
                        <a href="javascript:void(0);" class=" btn btn-outline-primary me-3 mb-2">
