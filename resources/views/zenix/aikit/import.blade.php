    ...
    <div class="row page-titles">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
          <a href="javascript:void(0);">Export/Import Settings</a>
        </li>
      </ol>
    </div>
    <div class="row">
      <div class="col-xl-12">
        ...
        <ul class="nav nav-tabs style-1 mb-4" id="pills-tab" role="tablist">
          ...
          <li class="nav-item" role="presentation">
            <a href="{{ url('aikit/import') }}" class="nav-link active border-s-1">Export/Import Settings</a>
          </li>
        </ul>
        <div class="row">
          <div class="col-xl-6">
              ...
              <div class="card-body">
                ...
                <ul class="setting-list">
                  <li class="mb-2">
                    ...
                    <a href="javascript:void(0);" class="text-primary ms-2">Export All Settings + Prompts</a>
                  </li>
                  <li>
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M15.75 11.25V14.25C15.75 14.6478 15.592 15.0294 15.3107 15.3107C15.0294 15.592 14.6478 15.75 14.25 15.75H3.75C3.35218 15.75 2.97064 15.592 2.68934 15.3107C2.40804 15.0294 2.25 14.6478 2.25 14.25V11.25" stroke="#362465" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                    ...
                    <a href="javascript:void(0);" class="text-primary ms-2"> Export Prompts only</a>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="dz-default mb-3">
                  ...
                  <small>
                    <strong class="text-black">Important:</strong> It's highly recommended to backup your current settings before importing new settings, so you can revert back if needed. </small>
                </div>
